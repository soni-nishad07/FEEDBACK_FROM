...
! function(t, e) {
    ...
    let t = 1e6,
        ...
        l = t => {
            ...
            let {
                ...
                transitionDelay: s
            } = window.getComputedStyle(t), n = Number.parseFloat(i), r = Number.parseFloat(s);
            return n || r ? (i = i.split(",")[0], s = s.split(",")[0], (Number.parseFloat(i) + Number.parseFloat(s)) * e) : 0
        },
        h = t => {
        ...
        x = (t, e, s = !0) => {
            ...
            let n = 5,
                ...
                a = ({
                    ...
                    s === e && (o = !0, e.removeEventListener(i, a), _(t))
                };
    ...
    function z(t, e) {
        return function i(s) {
            return j(s, {
                delegateTarget: t
            }), i.oneOff && q.off(t, s.type, e), e.apply(t, [s])
        }
    }
        ...
        return function s(n) {
            ...
            for (let {
                ...
                for (let a of r)
                    if (a === o) return j(n, {
                        delegateTarget: o
                    }), s.oneOff && q.off(t, n.type, e, i), i.apply(o, [n])
        }
    }
    ...
    function N(t, e, i, s, n) {
        ...
        let d = E(o, e.replace(k, "")),
            p = r ? M(t, i, o) : z(t, o);
        p.delegationSelector = r ? i : null, p.callable = o, p.oneOff = n, p.uidEvent = d, c[d] = p, t.addEventListener(a, p, r)
    }
    ...
    function W(t, e, i, s) {
        ...
        for (let r of Object.keys(n))
            if (r.includes(s)) {
                let o = n[r];
                H(t, e, i, o.callable, o.delegationSelector)
            }
    }

    function R(t) {
        return I[t = t.replace(D, "")] || t
    }
    let q = {
        on(t, e, i, s) {
            N(t, e, i, s, !1)
        ...
        off(t, e, i, s) {
            if ("string" != typeof e || !t) return;
            let [n, r, o] = L(e, i, s), a = o !== e, l = F(t), h = l[o] || {}, c = e.startsWith(".");
            if (void 0 !== r) {
            ...
            if (c)
                for (let u of Object.keys(l)) W(t, l, u, e.slice(1));
            for (let d of Object.keys(h)) {
                let p = d.replace(A, "");
                if (!a || e.includes(p)) {
                    let f = h[d];
                    H(t, l, o, f.callable, f.delegationSelector)
                }
            }
        },
        trigger(t, e, i) {
            ...
            let s = v(),
                ...
                l = !0,
                h = !1;
            r && s && (o = s.Event(e, i), s(t).trigger(o), a = !o.isPropagationStopped(), l = !o.isImmediatePropagationStopped(), h = o.isDefaultPrevented());
            let c = new Event(e, {
                bubbles: a,
                cancelable: !0
            });
            return c = j(c, i), h && c.preventDefault(), l && t.dispatchEvent(c), c.defaultPrevented && o && o.preventDefault(), c
        }
    };
        ...
        _typeCheckConfig(t, e = this.constructor.DefaultType) {
            for (let i of Object.keys(e)) {
                let n = e[i],
                    r = t[i],
                    o = c(r) ? "element" : s(r);
                if (!RegExp(n).test(o)) throw TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${i}" provided type "${o}" but expected type "${n}".`)
            }
        }
    }
    let Q = "5.2.2";
    class Z extends X {
        constructor(t, e) {
            ...
            this._element = t, this._config = this._getConfig(e), B.set(this._element, this.constructor.DATA_KEY, this)
        }
        dispose() {
            for (let t of (B.remove(this._element, this.constructor.DATA_KEY), q.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this))) this[t] = null
        }
        ...
        static getInstance(t) {
            return B.get(u(t), this.DATA_KEY)
        }
    ...
    let G = (t, e = "hide") => {
            let i = `click.dismiss${t.EVENT_KEY}`,
                s = t.NAME;
            q.on(document, i, `[data-bs-dismiss="${s}"]`, function(i) {
    ...
    class to extends Z {
        ...
        close() {
            let t = q.trigger(this._element, ti);
        ...
        _destroyElement() {
            this._element.remove(), q.trigger(this._element, ts), this.dispose()
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = to.getOrCreateInstance(this);
                if ("string" == typeof t) {
    ...
    class tf extends Z {
        ...
        toggle() {
            this._element.setAttribute("aria-pressed", this._element.classList.toggle(tu))
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = tf.getOrCreateInstance(this);
                "toggle" === t && e[t]()
            })
        }
    }
    q.on(document, tp, td, t => {
        t.preventDefault();
        let e = t.target.closest(td),
            i = tf.getOrCreateInstance(e);
        i.toggle()
    }), w(tf);
    let tg = {
    ...
    class tS extends X {
        constructor(t, e) {
            if (super(), this._element = t, !t || !tS.isSupported()) return;
        ...
        _initEvents() {
            this._supportPointerEvents ? (q.on(this._element, ty, t => this._start(t)), q.on(this._element, tw, t => this._end(t)), this._element.classList.add(tC)) : (q.on(this._element, t8, t => this._start(t)), q.on(this._element, tb, t => this._move(t)), q.on(this._element, t$, t => this._end(t)))
        }
        _eventIsPointerPenTouch(t) {
            return this._supportPointerEvents && (t.pointerType === tx || t.pointerType === t_)
        }
        static isSupported() {
    ...
    let tP = "carousel",
        ...
        t1 = "active",
        t7 = "slide",
        tV = "carousel-item-end",
        t5 = "carousel-item-start",
        tK = "carousel-item-next",
        tU = "carousel-item-prev",
        t6 = ".active",
        t2 = ".carousel-item",
        tX = t6 + t2,
        t4 = ".carousel-item img",
        tQ = ".carousel-indicators",
        tZ = "[data-bs-slide], [data-bs-slide-to]",
        tG = '[data-bs-ride="carousel"]',
        tJ = {
            [tF]: tN,
            [tz]: t0
        },
    ...
    class ei extends Z {
        constructor(t, e) {
            super(t, e), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = tg.findOne(tQ, this._element), this._addEventListeners(), this._config.ride === tB && this.cycle()
        }
        static get Default() {
            return et
        }
        ...
        _maybeEnableCycle() {
            if (this._config.ride) {
                if (this._isSliding) {
                    q.one(this._element, tW, () => this.cycle());
                    return
                }
                this.cycle()
            }
        ...
        to(t) {
            ...
            if (this._isSliding) {
                q.one(this._element, tW, () => this.to(t));
                return
            }
        ...
        _addEventListeners() {
            this._config.keyboard && q.on(this._element, tR, t => this._keydown(t)), "hover" === this._config.pause && (q.on(this._element, t9, () => this.pause()), q.on(this._element, tq, () => this._maybeEnableCycle())), this._config.touch && tS.isSupported() && this._addTouchEventListeners()
        }
        _addTouchEventListeners() {
            for (let t of tg.find(t4, this._element)) q.on(t, t3, t => t.preventDefault());
            let e = () => {
                    "hover" === this._config.pause && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout(() => this._maybeEnableCycle(), tM + this._config.interval))
                },
                i = {
                    leftCallback: () => this._slide(this._directionToOrder(t0)),
                    rightCallback: () => this._slide(this._directionToOrder(tN)),
                    endCallback: e
                };
            this._swipeHelper = new tS(this._element, i)
        }
        _keydown(t) {
        ...
        _setActiveIndicatorElement(t) {
            ...
            let e = tg.findOne(t6, this._indicatorsElement);
            e.classList.remove(t1), e.removeAttribute("aria-current");
            let i = tg.findOne(`[data-bs-slide-to="${t}"]`, this._indicatorsElement);
            i && (i.classList.add(t1), i.setAttribute("aria-current", "true"))
        }
        _updateInterval() {
        ...
        _slide(t, e = null) {
            ...
            let i = this._getActive(),
                s = t === tO,
                n = e || C(this._getItems(), i, s, this._config.wrap);
            if (n === i) return;
            let r = this._getItemIndex(n),
                o = e => q.trigger(this._element, e, {
                    relatedTarget: n,
            ...
            let u = () => {
                n.classList.remove(h, c), n.classList.add(t1), i.classList.remove(t1, c, h), this._isSliding = !1, o(tW)
            };
            this._queueCallback(u, i, this._isAnimated()), l && this.cycle()
        }
        _isAnimated() {
            return this._element.classList.contains(t7)
        }
        _getActive() {
            return tg.findOne(tX, this._element)
        }
        _getItems() {
            return tg.find(t2, this._element)
        }
        _clearInterval() {
            this._interval && (clearInterval(this._interval), this._interval = null)
        }
        _directionToOrder(t) {
            return y() ? t === t0 ? tL : tO : t === t0 ? tO : tL
        }
        _orderToDirection(t) {
            return y() ? t === tL ? t0 : tN : t === tL ? tN : t0
        }
        static jQueryInterface(t) {
            return this.each(function() {
    ...
    q.on(document, tY, tZ, function(t) {
        let e = a(this);
        ...
        let t = tg.find(tG);
        for (let e of t) ei.getOrCreateInstance(e)
    }), w(ei);
    let es = "collapse",
        en = "bs.collapse",
        er = `.${en}`,
    ...
    class ex extends Z {
        constructor(t, e) {
            ...
            for (let s of i) {
                let n = o(s),
                    r = tg.find(n).filter(t => t === this._element);
        ...
        show() {
            ...
            let t = [];
            if (this._config.parent && (t = this._getFirstLevelChildren(e$).filter(t => t !== this._element).map(t => ex.getOrCreateInstance(t, {
                    toggle: !1
                }))), t.length && t[0]._isTransitioning) return;
            let e = q.trigger(this._element, ea);
            if (e.defaultPrevented) return;
            for (let i of t) i.hide();
            let s = this._getDimension();
            this._element.classList.remove(ep), this._element.classList.add(ef), this._element.style[s] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
            let n = () => {
                    this._isTransitioning = !1, this._element.classList.remove(ef), this._element.classList.add(ep, ed), this._element.style[s] = "", q.trigger(this._element, el)
                },
        ...
        hide() {
            if (this._isTransitioning || !this._isShown()) return;
            let t = q.trigger(this._element, eh);
            if (t.defaultPrevented) return;
            let e = this._getDimension();
            for (let i of (this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`, m(this._element), this._element.classList.add(ef), this._element.classList.remove(ep, ed), this._triggerArray)) {
                let s = a(i);
                s && !this._isShown(s) && this._addAriaAndCollapsedClass([i], !1)
            }
            this._isTransitioning = !0;
            let n = () => {
                this._isTransitioning = !1, this._element.classList.remove(ef), this._element.classList.add(ep), q.trigger(this._element, ec)
            };
            this._element.style[e] = "", this._queueCallback(n, this._element, !0)
        }
        _isShown(t = this._element) {
            return t.classList.contains(ed)
        }
        _configAfterMerge(t) {
            return t.toggle = Boolean(t.toggle), t.parent = u(t.parent), t
        }
        _getDimension() {
            return this._element.classList.contains(ev) ? e8 : eb
        }
        _initializeChildren() {
        ...
        _getFirstLevelChildren(t) {
            let e = tg.find(em, this._config.parent);
            return tg.find(t, this._config.parent).filter(t => !e.includes(t))
        }
        _addAriaAndCollapsedClass(t, e) {
            if (t.length)
                for (let i of t) i.classList.toggle(eg, !e), i.setAttribute("aria-expanded", e)
        }
        static jQueryInterface(t) {
            let e = {};
            return "string" == typeof t && /show|hide/.test(t) && (e.toggle = !1), this.each(function() {
                let i = ex.getOrCreateInstance(this, e);
                if ("string" == typeof t) {
    ...
    q.on(document, eu, ey, function(t) {
        ("A" === t.target.tagName || t.delegateTarget && "A" === t.delegateTarget.tagName) && t.preventDefault();
        let e = o(this),
            i = tg.find(e);
        for (let s of i) ex.getOrCreateInstance(s, {
            toggle: !1
        }).toggle()
    }), w(ex);
    var eC = "top",
        ...
        ez = "popper",
        eM = "reference",
        eO = eP.reduce(function(t, e) {
            return t.concat([e + "-" + eI, e + "-" + eT])
        }, []),
        eL = [].concat(eP, [eS]).reduce(function(t, e) {
            return t.concat([e, e + "-" + eI, e + "-" + eT])
        }, []),
        e0 = "beforeRead",
        eN = "read",
        eH = "afterRead",
    ...
    function eK(t) {
        ...
        Object.keys(e.elements).forEach(function(t) {
            var i = e.styles[t] || {},
                s = e.attributes[t] || {},
                n = e.elements[t];
            eV(n) && eB(n) && (Object.assign(n.style, i), Object.keys(s).forEach(function(t) {
                var e = s[t];
        ...
        return Object.assign(e.elements.popper.style, i.popper), e.styles = i, e.elements.arrow && Object.assign(e.elements.arrow.style, i.arrow),
            function() {
                Object.keys(e.elements).forEach(function(t) {
                    ...
                    eV(s) && eB(s) && (Object.assign(s.style, r), Object.keys(n).forEach(function(t) {
                        s.removeAttribute(t)
                    }))
                })
            }
    ...
    function eJ(t, e, i) {
        ...
        var s = t.getBoundingClientRect(),
            n = 1,
            r = 1;
        e && eV(t) && (n = t.offsetWidth > 0 && eQ(s.width) / t.offsetWidth || 1, r = t.offsetHeight > 0 && eQ(s.height) / t.offsetHeight || 1);
        var o = (e7(t) ? e1(t) : window).visualViewport,
            a = !eG() && i,
            l = (s.left + (a && o ? o.offsetLeft : 0)) / n,
            h = (s.top + (a && o ? o.offsetTop : 0)) / r,
            c = s.width / n,
            u = s.height / r;
        return {
            width: c,
    ...
    function is(t) {
        return ["table", "td", "th"].indexOf(eB(t)) >= 0
    }

    function ir(t) {
        return ((e7(t) ? t.ownerDocument : t.document) || window.document).documentElement
    }

    function io(t) {
        return "html" === eB(t) ? t : t.assignedSlot || t.parentNode || (e5(t) ? t.host : null) || ir(t)
    }

    function ia(t) {
        return eV(t) && "fixed" !== ii(t).position ? t.offsetParent : null
    }

    function il(t) {
        var e = /firefox/i.test(eZ());
        if (/Trident/i.test(eZ()) && eV(t) && "fixed" === ii(t).position) return null;
        var i = io(t);
        for (e5(i) && (i = i.host); eV(i) && 0 > ["html", "body"].indexOf(eB(i));) {
            var s = ii(i);
    ...
    function ih(t) {
        for (var e = e1(t), i = ia(t); i && is(i) && "static" === ii(i).position;) i = ia(i);
        return i && ("html" === eB(i) || "body" === eB(i) && "static" === ii(i).position) ? e : i || il(t) || e
    }
    ...
    var iv = function t(e, i) {
        return ig("number" != typeof(e = "function" == typeof e ? e(Object.assign({}, i.rects, {
    ...
    function i8(t) {
        var e, i = t.state,
            ...
            a = e2(i.placement),
            l = ic(a),
            h = [eA, eD].indexOf(a) >= 0 ? "height" : "width";
        if (r && o) {
            var c = iv(n.padding, i),
                u = it(r),
                d = "y" === l ? eC : eA,
                p = "y" === l ? ek : eD,
                f = i.rects.reference[h] + i.rects.reference[l] - o[l] - i.rects.popper[h],
                ...
                _ = iu($, w, y),
                x = l;
            i.modifiersData[s] = ((e = {})[x] = _, e.centerOffset = _ - w, e)
        }
    }
    ...
    function ix(t) {
        ...
        if (c) {
            var x = ih(s),
                C = "clientHeight",
                k = "clientWidth";
            x === e1(s) && (x = ir(s), "static" !== ii(x).position && "absolute" === l && (C = "scrollHeight", k = "scrollWidth")), (r === eC || (r === eA || r === eD) && o === eT) && (w = ek, m -= (d && x === _ && _.visualViewport ? _.visualViewport.height : x[C]) - n.height, m *= h ? 1 : -1), (r === eA || (r === eC || r === ek) && o === eT) && (y = eD, f -= (d && x === _ && _.visualViewport ? _.visualViewport.width : x[k]) - n.width, f *= h ? 1 : -1)
        }
        var D = Object.assign({
                position: l
            }, c && iw),
        ...
        return (f = A.x, m = A.y, h) ? Object.assign({}, D, ((i = {})[w] = $ ? "0" : "", i[y] = b ? "0" : "", i.transform = 1 >= (_.devicePixelRatio || 1) ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)", i)) : Object.assign({}, D, ((e = {})[w] = $ ? m + "px" : "", e[y] = b ? f + "px" : "", e.transform = "", e))
    }
    ...
    function iC(t) {
        ...
        null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, ix(Object.assign({}, h, {
            offsets: e.modifiersData.popperOffsets,
            position: e.options.strategy,
            adaptive: o,
            roundOffsets: l
        })))), null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, ix(Object.assign({}, h, {
    ...
    function iA(t) {
        ...
        return r && h.forEach(function(t) {
                t.addEventListener("scroll", i.update, iD)
            }), a && l.addEventListener("resize", i.update, iD),
            function() {
                r && h.forEach(function(t) {
                    t.removeEventListener("scroll", i.update, iD)
                }), a && l.removeEventListener("resize", i.update, iD)
            }
    }
    let iS = {
        name: "eventListeners",
    ...
    function iz(t) {
        return eJ(ir(t)).left + iF(t).scrollLeft
    }
    ...
    function iO(t) {
        var e, i = ir(t),
            ...
            r = eX(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
            o = eX(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0),
            a = -s.scrollLeft + iz(t),
            l = -s.scrollTop;
        return "rtl" === ii(n || i).direction && (a += eX(i.clientWidth, n ? n.clientWidth : 0) - r), {
            width: r,
            height: o,
            x: a,
            y: l
    ...
    function i0(t) {
        return ["html", "body", "#document"].indexOf(eB(t)) >= 0 ? t.ownerDocument.body : eV(t) && iL(t) ? t : i0(io(t))
    }
    ...
    function iN(t, e) {
        ...
        var i, s = i0(t),
            ...
            r = e1(s),
            o = n ? [r].concat(r.visualViewport || [], iL(s) ? s : []) : s,
            a = e.concat(o);
        return n ? a : a.concat(iN(io(o)))
    }
    ...
    function iR(t, e, i) {
        return e === eF ? iH(iM(t, i)) : e7(e) ? iW(e, i) : iH(iO(ir(t)))
    }

    function i9(t) {
        var e = iN(io(t)),
            i = ["absolute", "fixed"].indexOf(ii(t).position) >= 0 && eV(t) ? ih(t) : t;
        return e7(i) ? e.filter(function(t) {
            return e7(t) && ie(t, i) && "body" !== eB(t)
        }) : []
    }

    function iq(t, e, i, s) {
        var n = [].concat("clippingParents" === e ? i9(t) : [].concat(e), [i]),
            r = n[0],
            o = n.reduce(function(e, i) {
                var n = iR(t, i, s);
                return e.top = eX(n.top, e.top), e.right = e4(n.right, e.right), e.bottom = e4(n.bottom, e.bottom), e.left = eX(n.left, e.left), e
            }, iR(t, r, s));
    ...
    function ij(t, e) {
        ...
        var i = e,
            ...
            g = i.padding,
            m = void 0 === g ? 0 : g,
            v = ig("number" != typeof m ? m : im(m, eP)),
            b = d === ez ? eM : ez,
            $ = t.rects.popper,
            y = t.elements[f ? b : d],
            w = iq(e7(y) ? y : y.contextElement || ir(t.elements.popper), l, c, o),
        ...
        if (d === ez && A) {
            ...
            Object.keys(D).forEach(function(t) {
                var e = [eD, ek].indexOf(t) >= 0 ? 1 : -1,
                    i = [eC, ek].indexOf(t) >= 0 ? "y" : "x";
                D[t] += S[i] * e
            })
        }
        return D
    ...
    function i1(t) {
        ...
        if (!e.modifiersData[s]._skip) {
            for (var n, r, o = i.mainAxis, a = void 0 === o || o, l = i.altAxis, h = void 0 === l || l, c = i.fallbackPlacements, u = i.padding, d = i.boundary, p = i.rootBoundary, f = i.altBoundary, g = i.flipVariations, m = void 0 === g || g, v = i.allowedAutoPlacements, b = e.options.placement, $ = e2(b) === b, y = [b].concat(c || ($ || !m ? [iI(b)] : iB(b))).reduce(function(t, i) {
                    return t.concat(e2(i) === eS ? iY(e, {
                        placement: i,
                        boundary: d,
                        rootBoundary: p,
                        padding: u,
                ...
                }, []), w = e.rects.reference, _ = e.rects.popper, x = new Map, C = !0, k = y[0], D = 0; D < y.length; D++) {
                var A = y[D],
                    S = e2(A),
                    P = iy(A) === eI,
                    I = [eC, ek].indexOf(S) >= 0,
                ...
                var z = iI(F),
                    M = [];
                if (a && M.push(E[S] <= 0), h && M.push(E[F] <= 0, E[z] <= 0), M.every(function(t) {
                        return t
                    })) {
                    k = A, C = !1;
                    break
            ...
            if (C)
                for (var O = m ? 3 : 1, L = function t(e) {
    ...
    function i5(t) {
        return [eC, eD, ek, eA].some(function(e) {
            return t[e] >= 0
        })
    }
    ...
    function i6(t, e, i) {
        var s = e2(t),
            n = [eA, eC].indexOf(s) >= 0 ? -1 : 1,
            r = "function" == typeof i ? i(Object.assign({}, e, {
                placement: t
            })) : i,
            o = r[0],
            a = r[1];
        return o = o || 0, a = (a || 0) * n, [eA, eD].indexOf(s) >= 0 ? {
            x: a,
            y: o
        } : {
            x: o,
    ...
    function i2(t) {
        var e = t.state,
            ...
            n = i.offset,
            r = void 0 === n ? [0, 0] : n,
            o = eL.reduce(function(t, i) {
                return t[i] = i6(i, e.rects, r), t
            }, {}),
            a = o[e.placement],
            l = a.x,
            h = a.y;
        null != e.modifiersData.popperOffsets && (e.modifiersData.popperOffsets.x += l, e.modifiersData.popperOffsets.y += h), e.modifiersData[s] = o
    }
    let iX = {
        name: "offset",
        enabled: !0,
        ...
        if (_) {
            if (r) {
                var P, I = "y" === y ? eC : eA,
                    ...
                    R = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ip(),
                    q = R[I],
                    j = R[T],
                    Y = iu(0, x[E], W[E]),
                    B = $ ? x[E] / 2 - O - Y - q - D.mainAxis : L - Y - q - D.mainAxis,
                    V = $ ? -x[E] / 2 + O + Y + j + D.mainAxis : N + Y + j + D.mainAxis,
                    K = e.elements.arrow && ih(e.elements.arrow),
                    U = K ? "y" === y ? K.clientTop || 0 : K.clientLeft || 0 : 0,
                    X = null != (P = null == A ? void 0 : A[y]) ? P : 0,
                    Q = F + B - X - U,
                    Z = F + V - X,
                    G = iu(p ? e4(z, Q) : z, F, p ? eX(M, Z) : M);
                _[y] = G, S[y] = G - F
            }
            if (a) {
                var J, tt = "x" === y ? eC : eA,
                    ...
                    tn = ti + m[tt],
                    tr = ti - m[te],
                    to = -1 !== [eC, eA].indexOf(v),
                    ta = null != (J = null == A ? void 0 : A[w]) ? J : 0,
                    tl = to ? tn : ti - x[ts] - C[ts] - ta + D.altAxis,
                    th = to ? ti + x[ts] + C[ts] - ta - D.altAxis : tr,
                    tc = p && to ? id(tl, ti, th) : iu(p ? tl : tn, ti, p ? th : tr);
                _[w] = tc, S[w] = tc - ti
            }
            e.modifiersData[s] = S
        }
    ...
    function se(t) {
        return t !== e1(t) && eV(t) ? st(t) : iF(t)
    }

    function si(t) {
        var e = t.getBoundingClientRect(),
            i = eQ(e.width) / t.offsetWidth || 1,
            s = eQ(e.height) / t.offsetHeight || 1;
        return 1 !== i || 1 !== s
    }
    ...
    function ss(t, e, i) {
        ...
        return (s || !s && !i) && (("body" !== eB(e) || iL(r)) && (a = se(e)), eV(e) ? (l = eJ(e, !0), l.x += e.clientLeft, l.y += e.clientTop) : r && (l.x = iz(r))), {
            ...
            var o = {
                ...
                h = {
                    ...
                    setOptions: function t(n) {
                        ...
                        u(), o.options = Object.assign({}, r, o.options, a), o.scrollParents = {
                            reference: e7(e) ? iN(e) : e.contextElement ? iN(e.contextElement) : [],
                            popper: iN(i)
                        };
                        var l = sr(sa([].concat(s, o.options.modifiers)));
                        return o.orderedModifiers = l.filter(function(t) {
                            return t.enabled
                        }), c(), h.update()
                    },
                    forceUpdate: function t() {
                        if (!l) {
                            ...
                            if (sh(i, s)) {
                                o.rects = {
                                    reference: ss(i, ih(s), "fixed" === o.options.strategy),
                                    popper: it(s)
    ...
    var su = sc(),
        ...
        sf = [iS, iQ, ik, e6, iX, i7, iJ, i$, iU],
        sg = sc({
            defaultModifiers: sf
        });
    let sm = Object.freeze(Object.defineProperty({
            __proto__: null,
            popperGenerator: sc,
            detectOverflow: ij,
            createPopperBase: su,
        ...
        sO = "dropup-center",
        sL = "dropdown-center",
        s0 = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',
        sN = `${s0}.${sE}`,
        sH = ".dropdown-menu",
        sW = ".navbar",
        sR = ".navbar-nav",
        s9 = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",
        sq = y() ? "top-end" : "top-start",
        s3 = y() ? "top-start" : "top-end",
        sj = y() ? "bottom-end" : "bottom-start",
        sY = y() ? "bottom-start" : "bottom-end",
        sB = y() ? "left-start" : "right-start",
    ...
    class sU extends Z {
        constructor(t, e) {
            super(t, e), this._popper = null, this._parent = this._element.parentNode, this._menu = tg.next(this._element, sH)[0] || tg.prev(this._element, sH)[0] || tg.findOne(sH, this._parent), this._inNavbar = this._detectNavbar()
        }
        static get Default() {
            return s5
        }
        ...
        show() {
            ...
            let t = {
                ...
                e = q.trigger(this._element, sA, t);
            if (!e.defaultPrevented) {
                if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(sR))
                    for (let i of [].concat(...document.body.children)) q.on(i, "mouseover", g);
                this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(sE), this._element.classList.add(sE), q.trigger(this._element, sS, t)
            }
        }
        hide() {
            if (p(this._element) || !this._isShown()) return;
        ...
        _completeHide(t) {
            let e = q.trigger(this._element, sk, t);
            if (!e.defaultPrevented) {
                if ("ontouchstart" in document.documentElement)
                    for (let i of [].concat(...document.body.children)) q.off(i, "mouseover", g);
                this._popper && this._popper.destroy(), this._menu.classList.remove(sE), this._element.classList.remove(sE), this._element.setAttribute("aria-expanded", "false"), U.removeDataAttribute(this._menu, "popper"), q.trigger(this._element, sD, t)
            }
        }
        _getConfig(t) {
            if ("object" == typeof(t = super._getConfig(t)).reference && !c(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw TypeError(`${sv.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
            return t
        }
        _createPopper() {
            if (void 0 === sm) throw TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
            let t = this._element;
            ...
            this._popper = sg(t, this._menu, e)
        }
        _isShown() {
        ...
        _selectMenuItem({
            ...
            let i = tg.find(s9, this._menu).filter(t => d(t));
            i.length && C(i, e, t === sx, !i.includes(e)).focus()
        }
        static jQueryInterface(t) {
            return this.each(function() {
        ...
        static clearMenus(t) {
            if (t.button === sC || "keyup" === t.type && t.key !== sw) return;
            let e = tg.find(sN);
            for (let i of e) {
                ...
                if (n.includes(s._element) || "inside" === s._config.autoClose && !r || "outside" === s._config.autoClose && r || s._menu.contains(t.target) && ("keyup" === t.type && t.key === sw || /input|select|option|textarea|form/i.test(t.target.tagName))) continue;
                let o = {
        ...
        static dataApiKeydownHandler(t) {
            let e = /input|textarea/i.test(t.target.tagName),
                i = t.key === sy,
                s = [s_, sx].includes(t.key);
            if (!s && !i || e && !i) return;
            t.preventDefault();
            let n = this.matches(s0) ? this : tg.prev(this, s0)[0] || tg.next(this, s0)[0] || tg.findOne(s0, t.delegateTarget.parentNode),
                r = sU.getOrCreateInstance(n);
            if (s) {
    ...
    q.on(document, sI, s0, sU.dataApiKeydownHandler), q.on(document, sI, sH, sU.dataApiKeydownHandler), q.on(document, sP, sU.clearMenus), q.on(document, sT, sU.clearMenus), q.on(document, sP, s0, function(t) {
        t.preventDefault(), sU.getOrCreateInstance(this).toggle()
    }), w(sU);
    let s6 = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
        s2 = ".sticky-top",
        sX = "padding-right",
        s4 = "margin-right";
    class sQ {
        ...
        hide() {
            let t = this.getWidth();
            this._disableOverFlow(), this._setElementAttributes(this._element, sX, e => e + t), this._setElementAttributes(s6, sX, e => e + t), this._setElementAttributes(s2, s4, e => e - t)
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, sX), this._resetElementAttributes(s6, sX), this._resetElementAttributes(s2, s4)
        }
        isOverflowing() {
        ...
        _applyManipulationCallback(t, e) {
            ...
            for (let i of tg.find(t, this._element)) e(i)
        }
    }
    let sZ = "backdrop",
        sG = "fade",
    ...
    class ns extends X {
        ...
        show(t) {
            ...
            this._config.isAnimated && m(e), e.classList.add(sJ), this._emulateAnimation(() => {
                _(t)
            })
        }
        hide(t) {
            ...
            this._getElement().classList.remove(sJ), this._emulateAnimation(() => {
                this.dispose(), _(t)
            })
        }
        dispose() {
            this._isAppended && (q.off(this._element, nt), this._element.remove(), this._isAppended = !1)
        }
        _getElement() {
            if (!this._element) {
                let t = document.createElement("div");
                t.className = this._config.className, this._config.isAnimated && t.classList.add(sG), this._element = t
            }
        ...
        _append() {
            ...
            this._config.rootElement.append(t), q.on(t, nt, () => {
    ...
    class nf extends X {
        ...
        activate() {
            !this._isActive && (this._config.autofocus && this._config.trapElement.focus(), q.off(document, no), q.on(document, na, t => this._handleFocusin(t)), q.on(document, nl, t => this._handleKeydown(t)), this._isActive = !0)
        }
        deactivate() {
            this._isActive && (this._isActive = !1, q.off(document, no))
        }
        _handleFocusin(t) {
            let {
                trapElement: e
            ...
            let i = tg.focusableChildren(e);
            0 === i.length ? e.focus() : this._lastTabNavDirection === nu ? i[i.length - 1].focus() : i[0].focus()
        }
        _handleKeydown(t) {
            t.key === nh && (this._lastTabNavDirection = t.shiftKey ? nu : nc)
        }
    }
    let ng = "modal",
        nm = "bs.modal",
        ...
        nC = `resize${nv}`,
        nk = `click.dismiss${nv}`,
        nD = `mousedown.dismiss${nv}`,
        nA = `keydown.dismiss${nv}`,
        nS = `click${nv}${n8}`,
        nP = "modal-open",
        nI = "fade",
        nT = "show",
    ...
    class nN extends Z {
        constructor(t, e) {
            super(t, e), this._dialog = tg.findOne(nz, this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new sQ, this._addEventListeners()
        }
        static get Default() {
            return nL
        }
        ...
        show(t) {
            ...
            let e = q.trigger(this._element, n_, {
                relatedTarget: t
            });
            !e.defaultPrevented && (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add(nP), this._adjustDialog(), this._backdrop.show(() => this._showElement(t)))
        }
        hide() {
            if (!this._isShown || this._isTransitioning) return;
            let t = q.trigger(this._element, n$);
            !t.defaultPrevented && (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(nT), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()))
        }
        dispose() {
            for (let t of [window, this._dialog]) q.off(t, nv);
        ...
        _showElement(t) {
            ...
            let e = tg.findOne(nM, this._dialog);
            e && (e.scrollTop = 0), m(this._element), this._element.classList.add(nT);
            let i = () => {
                this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, q.trigger(this._element, nx, {
                    relatedTarget: t
                })
            };
        ...
        _addEventListeners() {
            ...
            }), q.on(this._element, nD, t => {
                q.one(this._element, nk, e => {
        ...
        _hideModal() {
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
                document.body.classList.remove(nP), this._resetAdjustments(), this._scrollBar.reset(), q.trigger(this._element, nw)
            })
        }
        _isAnimated() {
            return this._element.classList.contains(nI)
        }
        _triggerBackdropTransition() {
            let t = q.trigger(this._element, ny);
            if (t.defaultPrevented) return;
        ...
        static jQueryInterface(t, e) {
            return this.each(function() {
                let i = nN.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === i[t]) throw TypeError(`No method named "${t}"`);
                    i[t](e)
                }
    ...
    q.on(document, nS, nO, function(t) {
        let e = a(this);
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), q.one(e, n_, t => {
            !t.defaultPrevented && q.one(e, nw, () => {
                d(this) && this.focus()
            })
        });
        let i = tg.findOne(nF);
        i && nN.getInstance(i).hide();
        let s = nN.getOrCreateInstance(e);
        s.toggle(this)
    }), G(nN), w(nN);
    let nH = "offcanvas",
        nW = "bs.offcanvas",
        ...
        n2 = `resize${nR}`,
        nX = `click${nR}${n9}`,
        n4 = `keydown.dismiss${nR}`,
        nQ = '[data-bs-toggle="offcanvas"]',
        nZ = {
            backdrop: !0,
            keyboard: !0,
            scroll: !1
    ...
    class nJ extends Z {
        ...
        show(t) {
            ...
            let e = q.trigger(this._element, nV, {
                relatedTarget: t
            });
            if (e.defaultPrevented) return;
            this._isShown = !0, this._backdrop.show(), this._config.scroll || new sQ().hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(nY);
            let i = () => {
                (!this._config.scroll || this._config.backdrop) && this._focustrap.activate(), this._element.classList.add(nj), this._element.classList.remove(nY), q.trigger(this._element, n5, {
                    relatedTarget: t
                })
            };
        ...
        hide() {
            if (!this._isShown) return;
            let t = q.trigger(this._element, nK);
            if (t.defaultPrevented) return;
            this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add(nB), this._backdrop.hide();
            let e = () => {
                this._element.classList.remove(nj, nB), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || new sQ().reset(), q.trigger(this._element, n6)
            };
    ...
    q.on(document, nX, nQ, function(t) {
        let e = a(this);
        ...
        for (let t of tg.find(n7)) nJ.getOrCreateInstance(t).show()
    }), q.on(window, n2, () => {
        for (let t of tg.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(t).position && nJ.getOrCreateInstance(t).hide()
    }), G(nJ), w(nJ);
    let rt = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        re = /^aria-[\w-]*$/i,
        ri = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
        rs = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
        rn = (t, e) => {
            let i = t.nodeName.toLowerCase();
            return e.includes(i) ? !rt.has(i) || Boolean(ri.test(t.nodeValue) || rs.test(t.nodeValue)) : e.filter(t => t instanceof RegExp).some(t => t.test(i))
        },
        rr = {
    ...
    function ro(t, e, i) {
        ...
        for (let o of r) {
            ...
            let l = [].concat(...o.attributes),
                h = [].concat(e["*"] || [], e[a] || []);
            for (let c of l) rn(c, h) || o.removeAttribute(c.nodeName)
        }
        return n.body.innerHTML
    }
    let ra = "TemplateFactory",
        rl = {
            allowList: rr,
            content: {},
            extraClass: "",
    ...
    class ru extends X {
        ...
        _maybeSanitize(t) {
            return this._config.sanitize ? ro(t, this._config.allowList, this._config.sanitizeFn) : t
        }
    ...
    class rO extends Z {
        constructor(t, e) {
            if (void 0 === sm) throw TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");
        ...
        dispose() {
            clearTimeout(this._timeout), q.off(this._element.closest(r8), rb, this._hideModalHandler), this.tip && this.tip.remove(), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose()
        }
        show() {
            if ("none" === this._element.style.display) throw Error("Please use show on visible elements");
            if (!(this._isWithContent() && this._isEnabled)) return;
            let t = q.trigger(this._element, this.constructor.eventName(rk)),
                e = f(this._element),
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(s), q.trigger(this._element, this.constructor.eventName(rA))), this._popper ? this._popper.update() : this._popper = this._createPopper(s), s.classList.add(rm), "ontouchstart" in document.documentElement)
                for (let r of [].concat(...document.body.children)) q.on(r, "mouseover", g);
            let o = () => {
                q.trigger(this._element, this.constructor.eventName(rD)), !1 === this._isHovered && this._leave(), this._isHovered = !1
            };
            this._queueCallback(o, this.tip, this._isAnimated())
        }
        hide() {
            if (!this._isShown()) return;
            let t = q.trigger(this._element, this.constructor.eventName(rx));
            if (t.defaultPrevented) return;
            let e = this._getTipElement();
            if (e.classList.remove(rm), "ontouchstart" in document.documentElement)
                for (let i of [].concat(...document.body.children)) q.off(i, "mouseover", g);
            this._activeTrigger[rw] = !1, this._activeTrigger[ry] = !1, this._activeTrigger[r$] = !1, this._isHovered = null;
            let s = () => {
                !this._isWithActiveTrigger() && (this._isHovered || e.remove(), this._element.removeAttribute("aria-describedby"), q.trigger(this._element, this.constructor.eventName(rC)), this._disposePopper())
            };
        ...
        _createTipElement(t) {
            ...
            if (!e) return null;
            e.classList.remove(rf, rm), e.classList.add(`bs-${this.constructor.NAME}-auto`);
            let i = n(this.constructor.NAME).toString();
            return e.setAttribute("id", i), this._isAnimated() && e.classList.add(rf), e
        }
        setContent(t) {
            this._newContent = t, this._isShown() && (this._disposePopper(), this.show())
        }
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new ru({ ...this._config,
                content: t,
        ...
        _isAnimated() {
            return this._config.animation || this.tip && this.tip.classList.contains(rf)
        }
        _isShown() {
            return this.tip && this.tip.classList.contains(rm)
        }
        _createPopper(t) {
            let e = "function" == typeof this._config.placement ? this._config.placement.call(this, t, this._element) : this._config.placement,
                i = rF[e.toUpperCase()];
            return sg(this._element, t, this._getPopperConfig(i))
        }
        _getOffset() {
            let {
                offset: t
        ...
        _setListeners() {
            ...
            for (let e of t)
                if ("click" === e) q.on(this._element, this.constructor.eventName(rS), this._config.selector, t => {
                    let e = this._initializeOnDelegatedTarget(t);
                    e.toggle()
                });
                else if (e !== r_) {
                let i = e === r$ ? this.constructor.eventName(rT) : this.constructor.eventName(rP),
                    s = e === r$ ? this.constructor.eventName(rE) : this.constructor.eventName(rI);
                q.on(this._element, i, this._config.selector, t => {
                    let e = this._initializeOnDelegatedTarget(t);
                    e._activeTrigger["focusin" === t.type ? ry : r$] = !0, e._enter()
                }), q.on(this._element, s, this._config.selector, t => {
                    let e = this._initializeOnDelegatedTarget(t);
                    e._activeTrigger["focusout" === t.type ? ry : r$] = e._element.contains(t.relatedTarget), e._leave()
                })
            }
            this._hideModalHandler = () => {
                this._element && this.hide()
            }, q.on(this._element.closest(r8), rb, this._hideModalHandler)
        }
        _fixTitle() {
        ...
        _getConfig(t) {
            ...
            for (let i of Object.keys(e)) rp.has(i) && delete e[i];
            return t = { ...e,
                ..."object" == typeof t && t ? t : {}
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = rO.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t]) throw TypeError(`No method named "${t}"`);
                    e[t]()
                }
    ...
    class rR extends rO {
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = rR.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t]) throw TypeError(`No method named "${t}"`);
                    e[t]()
                }
    ...
    class ot extends Z {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (q.off(this._config.target, rB), q.on(this._config.target, rB, rK, t => {
        ...
        _initializeTargetsAndObservables() {
            ...
            let t = tg.find(rK, this._config.target);
            for (let e of t) {
                if (!e.hash || p(e)) continue;
                let i = tg.findOne(e.hash, this._element);
                d(i) && (this._targetLinks.set(e.hash, e), this._observableSections.set(e.hash, i))
            }
        }
        _process(t) {
            this._activeTarget !== t && (this._clearActiveClass(this._config.target), this._activeTarget = t, t.classList.add(rV), this._activateParents(t), q.trigger(this._element, rY, {
                relatedTarget: t
            }))
        }
        _activateParents(t) {
            if (t.classList.contains(r7)) {
                tg.findOne(rZ, t.closest(rQ)).classList.add(rV);
                return
            }
            for (let e of tg.parents(t, rU))
                for (let i of tg.prev(e, r4)) i.classList.add(rV)
        }
        _clearActiveClass(t) {
            t.classList.remove(rV);
            let e = tg.find(`${rK}.${rV}`, t);
            for (let i of e) i.classList.remove(rV)
        }
        static jQueryInterface(t) {
            return this.each(function() {
    ...
    q.on(window, r1, () => {
        for (let t of tg.find(r5)) ot.getOrCreateInstance(t)
    }), w(ot);
    let oe = "tab",
        oi = "bs.tab",
        os = `.${oi}`,
        ...
        ob = ".dropdown-toggle",
        o$ = ".dropdown-menu",
        oy = ":not(.dropdown-toggle)",
        ow = '.list-group, .nav, [role="tablist"]',
        o_ = ".nav-item, .list-group-item",
        ox = `.nav-link${oy}, .list-group-item${oy}, [role="tab"]${oy}`,
        oC = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
        ok = `${ox}, ${oC}`,
        oD = `.${og}[data-bs-toggle="tab"], .${og}[data-bs-toggle="pill"], .${og}[data-bs-toggle="list"]`;
    class oA extends Z {
        constructor(t) {
            if (super(t), this._parent = this._element.closest(ow), !this._parent) return;
            this._setInitialAttributes(this._parent, this._getChildren()), q.on(this._element, oh, t => this._keydown(t))
        }
        static get NAME() {
            return oe
        }
        ...
        _activate(t, e) {
            if (!t) return;
            t.classList.add(og), this._activate(a(t));
            let i = () => {
                if ("tab" !== t.getAttribute("role")) {
                    t.classList.add(ov);
                    return
                }
                t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), q.trigger(t, oa, {
                    relatedTarget: e
                })
            };
            this._queueCallback(i, t, t.classList.contains(om))
        }
        _deactivate(t, e) {
            if (!t) return;
            t.classList.remove(og), t.blur(), this._deactivate(a(t));
            let i = () => {
                if ("tab" !== t.getAttribute("role")) {
                    t.classList.remove(ov);
                    return
                }
                t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), q.trigger(t, or, {
                    relatedTarget: e
                })
            };
            this._queueCallback(i, t, t.classList.contains(om))
        ...
        _keydown(t) {
            if (![ou, od, op, of ].includes(t.key)) return;
            t.stopPropagation(), t.preventDefault();
            let e = [od, of ].includes(t.key),
                i = C(this._getChildren().filter(t => !p(t)), t.target, e, !0);
            i && (i.focus({
                preventScroll: !0
            }), oA.getOrCreateInstance(i).show())
        }
        _getChildren() {
            return tg.find(ok, this._parent)
        }
        _getActiveElem() {
        ...
        _toggleDropDown(t, e) {
            ...
            if (!i.classList.contains(o8)) return;
            let s = (t, s) => {
                let n = tg.findOne(t, i);
                n && n.classList.toggle(s, e)
            };
            s(ob, og), s(o$, ov), i.setAttribute("aria-expanded", e)
        }
        _setAttributeIfNotExists(t, e, i) {
            t.hasAttribute(e) || t.setAttribute(e, i)
        }
        _elemIsActive(t) {
            return t.classList.contains(og)
        }
        _getInnerElement(t) {
            return t.matches(ok) ? t : tg.findOne(ok, t)
        }
        _getOuterElement(t) {
            return t.closest(o_) || t
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = oA.getOrCreateInstance(this);
                if ("string" == typeof t) {
                    if (void 0 === e[t] || t.startsWith("_") || "constructor" === t) throw TypeError(`No method named "${t}"`);
                    e[t]()
                }
    ...
    q.on(document, ol, oC, function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), !p(this) && oA.getOrCreateInstance(this).show()
    }), q.on(window, oc, () => {
        for (let t of tg.find(oD)) oA.getOrCreateInstance(t)
    }), w(oA);
    let oS = "toast",
        oP = "bs.toast",
        oI = `.${oP}`,
    ...
    class o3 extends Z {
        ...
        show() {
            let t = q.trigger(this._element, oL);
            if (t.defaultPrevented) return;
            this._clearTimeout(), this._config.animation && this._element.classList.add(oN);
            let e = () => {
                this._element.classList.remove(oR), q.trigger(this._element, o0), this._maybeScheduleHide()
            };
            this._element.classList.remove(oH), m(this._element), this._element.classList.add(oW, oR), this._queueCallback(e, this._element, this._config.animation)
        }
        hide() {
            if (!this.isShown()) return;
            let t = q.trigger(this._element, oM);
            if (t.defaultPrevented) return;
            let e = () => {
                this._element.classList.add(oH), this._element.classList.remove(oR, oW), q.trigger(this._element, oO)
            };
            this._element.classList.add(oR), this._queueCallback(e, this._element, this._config.animation)
        }
        dispose() {
            this._clearTimeout(), this.isShown() && this._element.classList.remove(oW), super.dispose()
        }
        isShown() {
            return this._element.classList.contains(oW)
        }
        _maybeScheduleHide() {
        ...
        _setListeners() {
            q.on(this._element, oT, t => this._onInteraction(t, !0)), q.on(this._element, oE, t => this._onInteraction(t, !1)), q.on(this._element, oF, t => this._onInteraction(t, !0)), q.on(this._element, oz, t => this._onInteraction(t, !1))
        }
        _clearTimeout() {
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = o3.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t]) throw TypeError(`No method named "${t}"`);
                    e[t](this)
                }
    ...
    function i(e, i) {
        ...
        if ("area" === n) {
            var r, o = e.parentNode,
                a = o.name;
            return !!e.href && !!a && "map" === o.nodeName.toLowerCase() && !!(r = t("img[usemap=#" + a + "]")[0]) && s(r)
        }
    ...
    t.ui = t.ui || {}, t.ui.version || (t.extend(t.ui, {
        ...
        plugin: {
            add: function(e, i, s) {
                ...
                for (var r in s) n.plugins[r] = n.plugins[r] || [], n.plugins[r].push([i, s[r]])
            },
            call: function(t, e, i) {
                var s = t.plugins[e];
        ...
        isOver: function(e, i, s, n, r, o) {
            return t.ui.isOverAxis(e, s, r) && t.ui.isOverAxis(i, n, o)
        }
    }))
}(jQuery),
function(t, e) {
    ...
    t.widget = function(e, i, s) {
        var n, r = e.split(".")[0];
        n = r + "-" + (e = e.split(".")[1]), s || (s = i, i = t.Widget), t.expr[":"][n] = function(i) {
            return !!t.data(i, e)
        }, t[r] = t[r] || {}, t[r][e] = function(t, e) {
            arguments.length && this._createWidget(t, e)
        };
        var o = new i;
        o.options = t.extend(!0, {}, o.options), t[r][e].prototype = t.extend(!0, o, {
            namespace: r,
            widgetName: e,
            widgetEventPrefix: t[r][e].prototype.widgetEventPrefix || e,
            widgetBaseClass: n
        }, s), t.widget.bridge(e, t[r][e])
    }, t.widget.bridge = function(i, s) {
        t.fn[i] = function(n) {
            var r = "string" == typeof n,
                o = Array.prototype.slice.call(arguments, 1),
                a = this;
            return n = !r && o.length ? t.extend.apply(null, [!0, n].concat(o)) : n, r && "_" === n.charAt(0) || (r ? this.each(function() {
                var s = t.data(this, i),
                    r = s && t.isFunction(s[n]) ? s[n].apply(s, o) : s;
                if (r !== s && r !== e) return a = r, !1
            }) : this.each(function() {
                var e = t.data(this, i);
        ...
        _trigger: function(e, i, s) {
            var n, r, o = this.options[e];
            if (s = s || {}, (i = t.Event(i)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(), i.target = this.element[0], r = i.originalEvent)
                for (n in r) n in i || (i[n] = r[n]);
            return this.element.trigger(i, s), !(t.isFunction(o) && !1 === o.call(this.element[0], i, s) || i.isDefaultPrevented())
        }
    }
}(jQuery),
function(t, e) {
...
function(t, e) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        _convertPositionTo: function(e, i) {
            ...
            return {
                top: i.top + this.offset.relative.top * s + this.offset.parent.top * s - (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : r ? 0 : n.scrollTop()) * s),
                left: i.left + this.offset.relative.left * s + this.offset.parent.left * s - (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : r ? 0 : n.scrollLeft()) * s)
            }
        },
        _generatePosition: function(e) {
            ...
            if (this.originalPosition) {
                if (this.containment) {
                    ...
                    e.pageX - this.offset.click.left < i[0] && (o = i[0] + this.offset.click.left), e.pageY - this.offset.click.top < i[1] && (a = i[1] + this.offset.click.top), e.pageX - this.offset.click.left > i[2] && (o = i[2] + this.offset.click.left), e.pageY - this.offset.click.top > i[3] && (a = i[3] + this.offset.click.top)
                }
                if (s.grid) {
            ...
            return {
                top: a - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : r ? 0 : n.scrollTop()),
                left: o - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : r ? 0 : n.scrollLeft())
            }
        },
        _clear: function() {
        ...
        drag: function(e, i) {
            var s = t(this).data("draggable"),
                n = s.options,
                r = !1;
            s.scrollParent[0] != document && "HTML" != s.scrollParent[0].tagName ? ((!n.axis || "x" != n.axis) && (s.overflowOffset.top + s.scrollParent[0].offsetHeight - e.pageY < n.scrollSensitivity ? s.scrollParent[0].scrollTop = r = s.scrollParent[0].scrollTop + n.scrollSpeed : e.pageY - s.overflowOffset.top < n.scrollSensitivity && (s.scrollParent[0].scrollTop = r = s.scrollParent[0].scrollTop - n.scrollSpeed)), (!n.axis || "y" != n.axis) && (s.overflowOffset.left + s.scrollParent[0].offsetWidth - e.pageX < n.scrollSensitivity ? s.scrollParent[0].scrollLeft = r = s.scrollParent[0].scrollLeft + n.scrollSpeed : e.pageX - s.overflowOffset.left < n.scrollSensitivity && (s.scrollParent[0].scrollLeft = r = s.scrollParent[0].scrollLeft - n.scrollSpeed))) : ((!n.axis || "x" != n.axis) && (e.pageY - t(document).scrollTop() < n.scrollSensitivity ? r = t(document).scrollTop(t(document).scrollTop() - n.scrollSpeed) : t(window).height() - (e.pageY - t(document).scrollTop()) < n.scrollSensitivity && (r = t(document).scrollTop(t(document).scrollTop() + n.scrollSpeed))), (!n.axis || "y" != n.axis) && (e.pageX - t(document).scrollLeft() < n.scrollSensitivity ? r = t(document).scrollLeft(t(document).scrollLeft() - n.scrollSpeed) : t(window).width() - (e.pageX - t(document).scrollLeft()) < n.scrollSensitivity && (r = t(document).scrollLeft(t(document).scrollLeft() + n.scrollSpeed)))), !1 !== r && t.ui.ddmanager && !n.dropBehaviour && t.ui.ddmanager.prepareOffsets(s, e)
        }
        ...
        drag: function(e, i) {
            for (var s = t(this).data("draggable"), n = s.options, r = n.snapTolerance, o = i.offset.left, a = o + s.helperProportions.width, l = i.offset.top, h = l + s.helperProportions.height, c = s.snapElements.length - 1; c >= 0; c--) {
                var u = s.snapElements[c].left,
                    d = u + s.snapElements[c].width,
                    p = s.snapElements[c].top,
                    f = p + s.snapElements[c].height;
                if (!(u - r < o && o < d + r && p - r < l && l < f + r || u - r < o && o < d + r && p - r < h && h < f + r || u - r < a && a < d + r && p - r < l && l < f + r || u - r < a && a < d + r && p - r < h && h < f + r)) {
        ...
        start: function(e, i) {
            ...
            if (n.length) {
                var r = parseInt(n[0].style.zIndex) || 0;
                t(n).each(function(t) {
                    this.style.zIndex = r + t
                }), this[0].style.zIndex = r + n.length
            }
        }
...
function(t, e) {
    t.widget("ui.droppable", {
        ...
        switch (s) {
            ...
            case "intersect":
                return l < n + e.helperProportions.width / 2 && r - e.helperProportions.width / 2 < h && c < o + e.helperProportions.height / 2 && a - e.helperProportions.height / 2 < u;
            case "pointer":
            ...
            case "touch":
                return (o >= c && o <= u || a >= c && a <= u || o < c && a > u) && (n >= l && n <= h || r >= l && r <= h || n < l && r > h);
            default:
                return !1
        }
    }, t.ui.ddmanager = {
            ...
            e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var s, n = t.ui.intersect(e, this, this.options.tolerance),
                        r = n || 1 != this.isover ? n && 0 == this.isover ? "isover" : null : "isout";
                    if (r) {
                        if (this.options.greedy) {
                            var o = this.element.parents(":data(droppable):eq(0)");
                            o.length && ((s = t.data(o[0], "droppable")).greedyChild = "isover" == r ? 1 : 0)
                        }
                        s && "isover" == r && (s.isover = 0, s.isout = 1, s._out.call(s, i)), this[r] = 1, this["isout" == r ? "isover" : "isout"] = 0, this["isover" == r ? "_over" : "_out"].call(this, i), s && "isout" == r && (s.isout = 0, s.isover = 1, s._over.call(s, i))
                    }
                }
            })
        },
...
function(t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function() {
            ...
            if (this.element.addClass("ui-resizable"), t.extend(this, {
                ...
                for (var n = 0; n < s.length; n++) {
                    var r = t.trim(s[n]),
                        o = t('<div class="ui-resizable-handle ui-resizable-' + r + '"></div>');
                    o.css({
                        zIndex: i.zIndex
                    }), "se" == r && o.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[r] = ".ui-resizable-" + r, this.element.append(o)
                }
            }
            this._renderAxis = function(e) {
                for (var i in e = e || this.element, this.handles) {
                    if (this.handles[i].constructor == String && (this.handles[i] = t(this.handles[i], this.element).show()), this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        ...
                        e.css(r, n), this._proportionallyResize()
                    }
        ...
        _mouseStart: function(e) {
            ...
            s.containment && (o += t(s.containment).scrollLeft() || 0, a += t(s.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: o,
                top: a
            ...
            return t("body").css("cursor", "auto" == l ? this.axis + "-resize" : l), r.addClass("ui-resizable-resizing"), this._propagate("start", e), !0
        },
        ...
        _mouseStop: function(e) {
            ...
            if (this._helper) {
                var n = this._proportionallyResizeElements,
                    ...
                    o = r && t.ui.hasScroll(n[0], "left") ? 0 : s.sizeDiff.height,
                    a = r ? 0 : s.sizeDiff.width,
                    l = {
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            }, (this._aspectRatio || t) && (e = o.minHeight * this.aspectRatio, n = o.minWidth / this.aspectRatio, i = o.maxHeight * this.aspectRatio, r = o.maxWidth / this.aspectRatio, e > o.minWidth && (o.minWidth = e), n > o.minHeight && (o.minHeight = n), i < o.maxWidth && (o.maxWidth = i), r < o.maxHeight && (o.maxHeight = r)), this._vBoundaries = o
        },
        ...
        _updateRatio: function(t, e) {
            ...
            var i = this.position,
                n = this.size,
                r = this.axis;
            return s(t.height) ? t.width = t.height * this.aspectRatio : s(t.width) && (t.height = t.width / this.aspectRatio), "sw" == r && (t.left = i.left + (n.width - t.width), t.top = null), "nw" == r && (t.top = i.top + (n.height - t.height), t.left = i.left + (n.width - t.width)), t
        },
        _respectSize: function(t, e) {
            this.helper;
            var i = this._vBoundaries,
                n = (this._aspectRatio || e.shiftKey, this.axis),
                r = s(t.width) && i.maxWidth && i.maxWidth < t.width,
            ...
            a && (t.width = i.minWidth), l && (t.height = i.minHeight), r && (t.width = i.maxWidth), o && (t.height = i.maxHeight);
            var h = this.originalPosition.left + this.originalSize.width,
                c = this.position.top + this.size.height,
                u = /sw|nw|w/.test(n),
                d = /nw|ne|n/.test(n);
            a && u && (t.left = h - i.minWidth), r && u && (t.left = h - i.maxWidth), l && d && (t.top = c - i.minHeight), o && d && (t.top = c - i.maxHeight);
                ...
                for (var e = this.helper || this.element, i = 0; i < this._proportionallyResizeElements.length; i++) {
                    ...
                    if (!this.borderDif) {
                        var n = [s.css("borderTopWidth"), s.css("borderRightWidth"), s.css("borderBottomWidth"), s.css("borderLeftWidth")],
                            r = [s.css("paddingTop"), s.css("paddingRight"), s.css("paddingBottom"), s.css("paddingLeft")];
        ...
        stop: function(e, i) {
            var s = t(this).data("resizable"),
                n = s.options,
                r = s._proportionallyResizeElements,
                o = r.length && /textarea/i.test(r[0].nodeName),
                a = o && t.ui.hasScroll(r[0], "left") ? 0 : s.sizeDiff.height,
                l = o ? 0 : s.sizeDiff.width,
                h = {
        ...
        start: function(e, s) {
            var n = t(this).data("resizable"),
                ...
                o = n.element,
                a = r.containment,
                l = a instanceof t ? a.get(0) : /parent/.test(a) ? o.parent().get(0) : a;
            if (l) {
        ...
        resize: function(e, i) {
            var s = t(this).data("resizable"),
                n = s.options,
                r = (s.containerSize, s.containerOffset),
                o = (s.size, s.position),
            ...
            h[0] != document && /static/.test(h.css("position")) && (l = r), o.left < (s._helper ? r.left : 0) && (s.size.width = s.size.width + (s._helper ? s.position.left - r.left : s.position.left - l.left), a && (s.size.height = s.size.width / s.aspectRatio), s.position.left = n.helper ? r.left : 0), o.top < (s._helper ? r.top : 0) && (s.size.height = s.size.height + (s._helper ? s.position.top - r.top : s.position.top), a && (s.size.width = s.size.height * s.aspectRatio), s.position.top = s._helper ? r.top : 0), s.offset.left = s.parentData.left + s.position.left, s.offset.top = s.parentData.top + s.position.top;
            var c = Math.abs((s._helper, s.offset.left - l.left + s.sizeDiff.width)),
                u = Math.abs((s._helper ? s.offset.top - l.top : s.offset.top - r.top) + s.sizeDiff.height),
        ...
        stop: function(e, i) {
            var s = t(this).data("resizable"),
                n = s.options,
                r = (s.position, s.containerOffset),
        ...
        resize: function(e, i) {
            ...
            var h = Math.round((r.width - o.width) / (n.grid[0] || 1)) * (n.grid[0] || 1),
                c = Math.round((r.height - o.height) / (n.grid[1] || 1)) * (n.grid[1] || 1);
            /^(se|s|e)$/.test(l) ? (s.size.width = o.width + h, s.size.height = o.height + c) : /^(ne)$/.test(l) ? (s.size.width = o.width + h, s.size.height = o.height + c, s.position.top = a.top - c) : /^(sw)$/.test(l) ? (s.size.width = o.width + h, s.size.height = o.height + c, s.position.left = a.left - h) : (s.size.width = o.width + h, s.size.height = o.height + c, s.position.top = a.top - c, s.position.left = a.left - h)
        }
    });
    var i = function(t) {
            ...
            if (this.dragged = !0, !this.options.disabled) {
                ...
                return this.helper.css({
                    ...
                    if (l && l.element != i.element[0]) {
                        var h = !1;
                        "touch" == s.tolerance ? h = !(l.left > o || l.right < n || l.top > a || l.bottom < r) : "fit" == s.tolerance && (h = l.left > n && l.right < o && l.top > r && l.bottom < a), h ? (l.selected && (l.$element.removeClass("ui-selected"), l.selected = !1), l.unselecting && (l.$element.removeClass("ui-unselecting"), l.unselecting = !1), l.selecting || (l.$element.addClass("ui-selecting"), l.selecting = !0, i._trigger("selecting", e, {
                            selecting: l.element
...
function(t, e) {
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseCapture: function(e, i) {
            ...
            if (t(e.target).parents().each(function() {
                    if (t.data(this, s.widgetName + "-item") == r) return n = t(this), !1
                }), t.data(e.target, s.widgetName + "-item") == r && (n = t(e.target)), !n) return !1;
        ...
        _mouseStart: function(e, i, s) {
            ...
            if (this.currentContainer = this, this.refreshPositions(), this.helper = this._createHelper(e), this._cacheHelperProportions(), this._cacheMargins(), this.scrollParent = this.helper.scrollParent(), this.offset = this.currentItem.offset(), this.offset = {
                ...
                for (var o = this.containers.length - 1; o >= 0; o--) this.containers[o]._trigger("activate", e, r._uiHash(this));
        ...
        _mouseDrag: function(e) {
            ...
            for (var n = this.items.length - 1; n >= 0; n--) {
                ...
                if (a && o != this.currentItem[0] && this.placeholder[1 == a ? "next" : "prev"]()[0] != o && !t.ui.contains(this.placeholder[0], o) && ("semi-dynamic" != this.options.type || !t.ui.contains(this.element[0], o))) {
                    if (this.direction = 1 == a ? "down" : "up", "pointer" == this.options.tolerance || this._intersectsWithSides(r)) this._rearrange(e, r);
                    else break;
        ...
        _intersectsWithPointer: function(e) {
            ...
            return !!n && (this.floating ? o && "right" == o || "down" == r ? 2 : 1 : r && ("down" == r ? 2 : 1))
        },
        _intersectsWithSides: function(e) {
            ...
            return this.floating && r ? "right" == r && s || "left" == r && !s : n && ("down" == n && i || "up" == n && !i)
        },
        ...
        _getItemsAsjQuery: function(e) {
            ...
            if (n && e)
                for (var r = n.length - 1; r >= 0; r--)
                    for (var o = t(n[r]), a = o.length - 1; a >= 0; a--) {
            ...
            for (var r = s.length - 1; r >= 0; r--) s[r][0].each(function() {
                i.push(this)
            });
            return t(i)
        },
        ...
        _refreshItems: function(e) {
            ...
            for (var r = s.length - 1; r >= 0; r--)
                for (var h = s[r][1], c = s[r][0], a = 0, u = c.length; a < u; a++) {
                    var d = t(c[a]);
        ...
        _contactContainers: function(e) {
            ...
            if (i) {
                if (1 === this.containers.length) this.containers[s]._trigger("over", e, this._uiHash(this)), this.containers[s].containerCache.over = 1;
                    ...
                    for (var r = 1e4, o = null, a = this.positionAbs[this.containers[s].floating ? "left" : "top"], l = this.items.length - 1; l >= 0; l--)
                        if (t.ui.contains(this.containers[s].element[0], this.items[l].item[0])) {
                            ...
                            Math.abs(h - a) < r && (r = Math.abs(h - a), o = this.items[l], this.direction = h - a > 0 ? "down" : "up")
                        }
        ...
        _convertPositionTo: function(e, i) {
            ...
            var s = "absolute" == e ? 1 : -1,
                ...
                r = /(html|body)/i.test(n[0].tagName);
            return {
                top: i.top + this.offset.relative.top * s + this.offset.parent.top * s - (t.browser.safari && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : r ? 0 : n.scrollTop()) * s),
                left: i.left + this.offset.relative.left * s + this.offset.parent.left * s - (t.browser.safari && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : r ? 0 : n.scrollLeft()) * s)
            }
        },
        _generatePosition: function(e) {
            var i = this.options,
            ...
            if (this.originalPosition && (this.containment && (e.pageX - this.offset.click.left < this.containment[0] && (r = this.containment[0] + this.offset.click.left), e.pageY - this.offset.click.top < this.containment[1] && (o = this.containment[1] + this.offset.click.top), e.pageX - this.offset.click.left > this.containment[2] && (r = this.containment[2] + this.offset.click.left), e.pageY - this.offset.click.top > this.containment[3] && (o = this.containment[3] + this.offset.click.top)), i.grid)) {
                ...
                o = this.containment && (a - this.offset.click.top < this.containment[1] || a - this.offset.click.top > this.containment[3]) ? a - this.offset.click.top < this.containment[1] ? a + i.grid[1] : a - i.grid[1] : a;
            ...
            return {
                ...
                left: r - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (t.browser.safari && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : n ? 0 : s.scrollLeft())
            }
        },
        _rearrange: function(t, e, i, s) {
            ...
            window.setTimeout(function() {
                r == n.counter && n.refreshPositions(!s)
            }, 0)
        },
        _clear: function(e, i) {
            this.reverting = !1;
        ...
        t.effects.animateClass = function(e, i, s, a) {
            return t.isFunction(s) && (a = s, s = null), this.queue(function() {
                ...
                t.each(c, function(t, i) {
                    e[i] && h[i + "Class"](e[i])
                }), l = r(n.call(this)), h.attr("class", p), h.animate(o(d, l), {
                    queue: !1,
                    duration: i,
                    easing: s,
                    complete: function() {
            ...
            toggleClass: function(i, s, n, r, o) {
                return "boolean" == typeof s || s === e ? n ? t.effects.animateClass.apply(this, [s ? {
                    add: i
                } : {
                    remove: i
                }, n, r, o]) : this._toggleClass(i, s) : t.effects.animateClass.apply(this, [{
                    toggle: i
                }, s, n, r])
            },
            switchClass: function(e, i, s, n, r) {
            ...
            effect: function(e, i, s, n) {
                var r = a.apply(this, arguments),
                    ...
                    l = o.options.mode,
                    h = t.effects[e];
                return t.fx.off || !h ? l ? this[l](o.duration, o.callback) : this.each(function() {
            ...
            easeInOutElastic: function(t, e, i, s, n) {
                ...
                if (o || (o = .3 * n * 1.5), a < Math.abs(s)) {
                    a = s;
                    var r = o / 4
                } else var r = o / (2 * Math.PI) * Math.asin(s / a);
                return e < 1 ? -.5 * a * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * n - r) * 2 * Math.PI / o) + i : a * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * n - r) * 2 * Math.PI / o) * .5 + s + i
            },
            easeInBack: function(t, i, s, n, r, o) {
                return o == e && (o = 1.70158), n * (i /= r) * i * ((o + 1) * i - o) + s
            },
            easeOutBack: function(t, i, s, n, r, o) {
                return o == e && (o = 1.70158), n * ((i = i / r - 1) * i * ((o + 1) * i + o) + 1) + s
            },
            easeInOutBack: function(t, i, s, n, r, o) {
                return o == e && (o = 1.70158), (i /= r / 2) < 1 ? n / 2 * i * i * (((o *= 1.525) + 1) * i - o) + s : n / 2 * ((i -= 2) * i * (((o *= 1.525) + 1) * i + o) + 2) + s
            },
            ...
            easeInOutBounce: function(e, i, s, n, r) {
                return i < r / 2 ? .5 * t.easing.easeInBounce(e, 2 * i, 0, n, r) + s : .5 * t.easing.easeOutBounce(e, 2 * i - r, 0, n, r) + .5 * n + s
            }
        })
    }(jQuery),
    function(t, e) {
        t.effects.blind = function(e) {
            return this.queue(function() {
                var i = t(this),
                    ...
                    r = e.options.direction || "vertical";
                t.effects.save(i, s), i.show();
                var o = t.effects.createWrapper(i).css({
                        overflow: "hidden"
                    }),
                    a = "vertical" == r ? "height" : "width",
                    l = "vertical" == r ? o.height() : o.width();
                "show" == n && o.css(a, 0);
                var h = {};
                h[a] = "show" == n ? l : 0, o.animate(h, e.duration, e.options.easing, function() {
        ...
        t.effects.bounce = function(e) {
            return this.queue(function() {
                var i = t(this),
                    ...
                    r = e.options.direction || "up",
                    o = e.options.distance || 20,
                    a = e.options.times || 5,
                    l = e.duration || 250;
                /show|hide/.test(n) && s.push("opacity"), t.effects.save(i, s), i.show(), t.effects.createWrapper(i);
                var h = "up" == r || "down" == r ? "top" : "left",
                    c = "up" == r || "left" == r ? "pos" : "neg",
                    o = e.options.distance || ("top" == h ? i.outerHeight(!0) / 3 : i.outerWidth(!0) / 3);
                if ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -o : o), "hide" == n && (o /= 2 * a), "hide" != n && a--, "show" == n) {
                    var u = {
                        opacity: 1
                    };
                    u[h] = ("pos" == c ? "+=" : "-=") + o, i.animate(u, l / 2, e.options.easing), o /= 2, a--
                }
                for (var d = 0; d < a; d++) {
                    var p = {},
                        f = {};
                    p[h] = ("pos" == c ? "-=" : "+=") + o, f[h] = ("pos" == c ? "+=" : "-=") + o, i.animate(p, l / 2, e.options.easing).animate(f, l / 2, e.options.easing), o = "hide" == n ? 2 * o : o / 2
                }
                if ("hide" == n) {
                    var u = {
                        opacity: 0
                    };
                    u[h] = ("pos" == c ? "-=" : "+=") + o, i.animate(u, l / 2, e.options.easing, function() {
                        i.hide(), t.effects.restore(i, s), t.effects.removeWrapper(i), e.callback && e.callback.apply(this, arguments)
                    })
                } else {
                    var p = {},
                        f = {};
                    p[h] = ("pos" == c ? "-=" : "+=") + o, f[h] = ("pos" == c ? "+=" : "-=") + o, i.animate(p, l / 2, e.options.easing).animate(f, l / 2, e.options.easing, function() {
        ...
        t.effects.clip = function(e) {
            return this.queue(function() {
                ...
                var o = t.effects.createWrapper(i).css({
                    ...
                    a = "IMG" == i[0].tagName ? o : i,
                    l = {
                        size: "vertical" == r ? "height" : "width",
                        position: "vertical" == r ? "top" : "left"
                    },
                    h = "vertical" == r ? a.height() : a.width();
        ...
        t.effects.drop = function(e) {
            return this.queue(function() {
                var i = t(this),
                    ...
                    n = t.effects.setMode(i, e.options.mode || "hide"),
                    r = e.options.direction || "left";
                t.effects.save(i, s), i.show(), t.effects.createWrapper(i);
                var o = "up" == r || "down" == r ? "top" : "left",
                    a = "up" == r || "left" == r ? "pos" : "neg",
                    l = e.options.distance || ("top" == o ? i.outerHeight(!0) / 2 : i.outerWidth(!0) / 2);
                "show" == n && i.css("opacity", 0).css(o, "pos" == a ? -l : l);
                var h = {
                    opacity: "show" == n ? 1 : 0
                };
                h[o] = ("show" == n ? "pos" == a ? "+=" : "-=" : "pos" == a ? "-=" : "+=") + l, i.animate(h, {
                    queue: !1,
                    duration: e.duration,
                    easing: e.options.easing,
                    complete: function() {
        ...
        t.effects.explode = function(e) {
            return this.queue(function() {
                ...
                var n = t(this).show().css("visibility", "hidden"),
                    r = n.offset();
                r.top -= parseInt(n.css("marginTop"), 10) || 0, r.left -= parseInt(n.css("marginLeft"), 10) || 0;
                for (var o = n.outerWidth(!0), a = n.outerHeight(!0), l = 0; l < i; l++)
                    for (var h = 0; h < s; h++) n.clone().appendTo("body").wrap("<div></div>").css({
                        ...
                        width: o / s,
                        height: a / i,
                        left: r.left + h * (o / s) + ("show" == e.options.mode ? (h - Math.floor(s / 2)) * (o / s) : 0),
                        top: r.top + l * (a / i) + ("show" == e.options.mode ? (l - Math.floor(i / 2)) * (a / i) : 0),
                        opacity: "show" == e.options.mode ? 0 : 1
                    }).animate({
                        left: r.left + h * (o / s) + ("show" == e.options.mode ? 0 : (h - Math.floor(s / 2)) * (o / s)),
                        top: r.top + l * (a / i) + ("show" == e.options.mode ? 0 : (l - Math.floor(i / 2)) * (a / i)),
        ...
        t.effects.fold = function(e) {
            return this.queue(function() {
                ...
                var l = t.effects.createWrapper(i).css({
                    ...
                    d = /([0-9]+)%/.exec(r);
                d && (r = parseInt(d[1], 10) / 100 * u["hide" == n ? 0 : 1]), "show" == n && l.css(o ? {
                    height: 0,
                    width: r
                } : {
                    height: r,
                ...
                var p = {},
                    f = {};
                p[c[0]] = "show" == n ? u[0] : r, f[c[1]] = "show" == n ? u[1] : 0, l.animate(p, a, e.options.easing).animate(f, a, e.options.easing, function() {
                    "hide" == n && i.hide(), t.effects.restore(i, s), t.effects.removeWrapper(i), e.callback && e.callback.apply(i[0], arguments), i.dequeue()
                })
            })
        }
    ...
    function(t, e) {
        t.effects.highlight = function(e) {
            return this.queue(function() {
                ...
                "hide" == n && (r.opacity = 0), t.effects.save(i, s), i.show().css({
        ...
        t.effects.pulsate = function(e) {
            return this.queue(function() {
                var i = t(this),
                    ...
                    o = i.is(":visible"),
                    a = 0;
                o || (i.css("opacity", 0).show(), a = 1), ("hide" == s && o || "show" == s && !o) && n--;
                for (var l = 0; l < n; l++) i.animate({
                    opacity: a
                }, r, e.options.easing), a = (a + 1) % 2;
                i.animate({
                    opacity: a
                }, r, e.options.easing, function() {
        ...
        t.effects.puff = function(e) {
            ...
            return this.queue(function() {
                var i = t(this),
                    ...
                    n = t.effects.setMode(i, e.options.mode || "effect"),
                    r = parseInt(e.options.percent, 10) || (0 == parseInt(e.options.percent, 10) ? 0 : "hide" == n ? 0 : 100),
        ...
        t.effects.shake = function(e) {
            return this.queue(function() {
                ...
                var l = "up" == n || "down" == n ? "top" : "left",
                    ...
                    u = {},
                    d = {};
                c[l] = ("pos" == h ? "-=" : "+=") + r, u[l] = ("pos" == h ? "+=" : "-=") + 2 * r, d[l] = ("pos" == h ? "-=" : "+=") + 2 * r, i.animate(c, a, e.options.easing);
                for (var p = 1; p < o; p++) i.animate(u, a, e.options.easing).animate(d, a, e.options.easing);
    ...
    function(t, e) {
        t.effects.slide = function(e) {
            return this.queue(function() {
                ...
                var o = "up" == r || "down" == r ? "top" : "left",
                    a = "up" == r || "left" == r ? "pos" : "neg",
                    l = e.options.distance || ("top" == o ? i.outerHeight(!0) : i.outerWidth(!0));
                "show" == n && i.css(o, "pos" == a ? isNaN(l) ? "-" + l : -l : l);
                var h = {};
                h[o] = ("show" == n ? "pos" == a ? "+=" : "-=" : "pos" == a ? "-=" : "+=") + l, i.animate(h, {
                    queue: !1,
                    duration: e.duration,
    ...
    function(t, e) {
        t.widget("ui.accordion", {
            ...
            _keydown: function(e) {
                if (!this.options.disabled && !e.altKey && !e.ctrlKey) {
                    ...
                    switch (e.keyCode) {
                        case i.RIGHT:
                        case i.DOWN:
                            r = this.headers[(n + 1) % s];
                            break;
                        case i.LEFT:
                        case i.UP:
                            r = this.headers[(n - 1 + s) % s];
                            break;
                        case i.SPACE:
                        case i.ENTER:
                            this._clickHandler({
                    ...
                    return !r || (t(e.target).attr("tabIndex", -1), t(r).attr("tabIndex", 0), r.focus(), !1)
                }
            },
            resize: function() {
            ...
            _toggle: function(e, i, s, n, r) {
                ...
                if (o._trigger("changestart", null, o.data), o.running = 0 === i.size() ? e.size() : i.size(), a.animated) {
                    var h = {};
                    h = a.collapsible && n ? {
                        toShow: t([]),
                        toHide: i,
            ...
            animations: {
                slide: function(e, i) {
                    ...
                    s = h[0].style.width, h.width(h.parent().width() - parseFloat(h.css("paddingLeft")) - parseFloat(h.css("paddingRight")) - (parseFloat(h.css("borderLeftWidth")) || 0) - (parseFloat(h.css("borderRightWidth")) || 0)), t.each(l, function(i, s) {
                        ...
                        step: function(t, i) {
                            "height" == i.prop && (r = i.end - i.start == 0 ? 0 : (i.now - i.start) / (i.end - i.start)), e.toShow[0].style[i.prop] = r * o[i.prop].value + o[i.prop].unit
                        },
                        duration: e.duration,
                        easing: e.easing,
                        complete: function() {
                ...
                this.isMultiLine = this.element.is("textarea"), this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({
                    ...
                    selected: function(t, e) {
                        var n = e.item.data("item.autocomplete"),
                            r = i.previous;
                        i.element[0] !== s.activeElement && (i.element.focus(), i.previous = r, setTimeout(function() {
                            i.previous = r, i.selectedItem = n
    ...
    function(t, e) {
        var i, s, n, r, o = "ui-button ui-widget ui-state-default ui-corner-all",
        ...
        t.widget("ui.button", {
            ...
            _create: function() {
                ...
                null === a.label && (a.label = this.buttonElement.html()), this.buttonElement.addClass(o).attr("role", "button").bind("mouseenter.button", function() {
                    ...
                    a.disabled || (r = !1, s = t.pageX, n = t.pageY)
                }).bind("mouseup.button", function(t) {
                    a.disabled || s === t.pageX && n === t.pageY || (r = !0)
            ...
            destroy: function() {
                this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(o + " " + a + " " + l).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title"), t.Widget.prototype.destroy.call(this)
            },
            _setOption: function(e, i) {
            ...
            _resetButton: function() {
                ...
                var e = this.buttonElement.removeClass(l),
                    ...
                    r = [];
                s.primary || s.secondary ? (this.options.text && r.push("ui-button-text-icon" + (n ? "s" : s.primary ? "-primary" : "-secondary")), s.primary && e.prepend("<span class='ui-button-icon-primary ui-icon " + s.primary + "'></span>"), s.secondary && e.append("<span class='ui-button-icon-secondary ui-icon " + s.secondary + "'></span>"), this.options.text || (r.push(n ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || e.attr("title", i))) : r.push("ui-button-text-only"), e.addClass(r.join(" "))
            }
        ...
        $.extend(Datepicker.prototype, {
            ...
            _dialogDatepicker: function(t, e, i, s, n) {
                ...
                if (!r) {
                    this.uuid += 1;
                    var o = "dp" + this.uuid;
                    this._dialogInput = $('<input type="text" id="' + o + '" style="position: absolute; top: -100px; width: 0px;"/>'), this._dialogInput.keydown(this._doKeyDown), $("body").append(this._dialogInput), (r = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, $.data(this._dialogInput[0], PROP_NAME, r)
                }
                if (extendRemove(r.settings, s || {}), e = e && e.constructor == Date ? this._formatDate(r, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, !this._pos) {
                ...
                if ("input" != (t = t.target || t).nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                    ...
                    if (!1 !== s) {
                        ...
                        if ($.datepicker._pos = null, e.dpDiv.empty(), e.dpDiv.css({
                                ...
                                display: "block",
                                top: "-1000px"
                            }), $.datepicker._updateDatepicker(e), r = $.datepicker._checkOffset(e, r, n), e.dpDiv.css({
                            ...
                            e.dpDiv.zIndex($(t).zIndex() + 1), $.datepicker._datepickerShowing = !0, $.effects && $.effects[o] ? e.dpDiv.show(o, $.datepicker._get(e, "showOptions"), a, l) : e.dpDiv[o || "show"](o ? a : null, l), o && a || l(), e.input.is(":visible") && !e.input.is(":disabled") && e.input.focus(), $.datepicker._curInst = e
                        }
                    }
                }
            },
            ...
            _checkOffset: function(t, e, i) {
                ...
                return e.left -= this._get(t, "isRTL") ? s - r : 0, e.left -= i && e.left == t.input.offset().left ? $(document).scrollLeft() : 0, e.top -= i && e.top == t.input.offset().top + o ? $(document).scrollTop() : 0, e.left -= Math.min(e.left, e.left + s > a && a > s ? Math.abs(e.left + s - a) : 0), e.top -= Math.min(e.top, e.top + n > l && l > n ? Math.abs(n + o) : 0), e
            },
            _findPos: function(t) {
            ...
            _selectDay: function(t, e, i, s) {
                ...
                if (!($(s).hasClass(this._unselectableClass) || this._isDisabledDatepicker(n[0]))) {
                    ...
                    r.selectedDay = r.currentDay = $("a", s).html(), r.selectedMonth = r.currentMonth = e, r.selectedYear = r.currentYear = i, this._selectDate(t, this._formatDate(r, r.currentDay, r.currentMonth, r.currentYear))
                }
            },
            ...
            parseDate: function(t, e, i) {
                ...
                for (var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, r = (i ? i.dayNames : null) || this._defaults.dayNames, o = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, a = (i ? i.monthNames : null) || this._defaults.monthNames, l = -1, h = -1, c = -1, u = -1, d = !1, p = function(e) {
                        ...
                        if ($.each(n, function(t, i) {
                                var s = i[1];
                                if (e.substr(v, s.length).toLowerCase() == s.toLowerCase()) return r = i[0], v += s.length, !1
                            }), -1 != r) return r + 1;
            ...
            _determineDate: function(t, e, i) {
                var s = function(t) {
                    ...
                    n = function(e) {
                        ...
                        for (var s = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, n = s.getFullYear(), r = s.getMonth(), o = s.getDate(), a = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, l = a.exec(e); l;) {
                            switch (l[2] || "d") {
                                case "d":
                                case "D":
                                    o += parseInt(l[1], 10);
                                ...
                                case "m":
                                case "M":
                                    r += parseInt(l[1], 10), o = Math.min(o, $.datepicker._getDaysInMonth(n, r));
                                    break;
                                case "y":
                                case "Y":
                                    n += parseInt(l[1], 10), o = Math.min(o, $.datepicker._getDaysInMonth(n, r))
                            }
                            l = a.exec(e)
                        }
                        return new Date(n, r, o)
                    },
                    r = null == e || "" === e ? i : "string" == typeof e ? n(e) : "number" == typeof e ? isNaN(e) ? i : s(e) : new Date(e.getTime());
            ...
            _setDate: function(t, e, i) {
                ...
                t.selectedDay = t.currentDay = o.getDate(), t.drawMonth = t.selectedMonth = t.currentMonth = o.getMonth(), t.drawYear = t.selectedYear = t.currentYear = o.getFullYear(), n == t.selectedMonth && r == t.selectedYear || i || this._notifyChange(t), this._adjustInstDate(t), t.input && t.input.val(s ? "" : this._formatDate(t))
            },
            _getDate: function(t) {
            ...
            _generateHTML: function(t) {
                ...
                b = r ? this.formatDate(b, this._daylightSavingAdjust(new Date(f, p + l, 1)), this._getFormatConfig(t)) : b;
                ...
                w = r ? this.formatDate(w, _, this._getFormatConfig(t)) : w;
                ...
                k = isNaN(k) ? 0 : k;
                for (var D = this._get(t, "showWeek"), A = this._get(t, "dayNames"), S = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), P = this._get(t, "monthNames"), I = this._get(t, "monthNamesShort"), T = this._get(t, "beforeShowDay"), E = this._get(t, "showOtherMonths"), F = this._get(t, "selectOtherMonths"), z = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), M = "", O = 0; O < o[0]; O++) {
                    var L = "";
                    this.maxRows = 4;
                    for (var N = 0; N < o[1]; N++) {
                        var H = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
                            ...
                            R = "";
                        if (h) {
                            if (R += '<div class="ui-datepicker-group', o[1] > 1) switch (N) {
                                case 0:
                        ...
                        R += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + W + '">' + (/all|left/.test(W) && 0 == O ? i ? y : v : "") + (/all|right/.test(W) && 0 == O ? i ? v : y : "") + this._generateMonthYearHeader(t, p, f, u, d, O > 0 || N > 0, P, I) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                        ...
                        this.maxRows = U;
                        for (var X = this._daylightSavingAdjust(new Date(f, p, 1 - V)), Q = 0; Q < U; Q++) {
                            R += "<tr>";
                            for (var Z = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(X) + "</td>" : "", j = 0; j < 7; j++) {
                                var G = T ? T.apply(t.input ? t.input[0] : null, [X]) : [!0, ""],
                                    J = X.getMonth() != p,
                                    tt = J && !F || !G[0] || u && X < u || d && X > d;
                                Z += '<td class="' + ((j + k + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (X.getTime() == H.getTime() && p == t.selectedMonth && t._keyEvent || z.getTime() == X.getTime() && z.getTime() == H.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !E ? "" : " " + G[1] + (X.getTime() == c.getTime() ? " " + this._currentClass : "") + (X.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!J || E) && G[2] ? ' title="' + G[2] + '"' : "") + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + X.getMonth() + '" data-year="' + X.getFullYear() + '"') + ">" + (J && !E ? "&#xa0;" : tt ? '<span class="ui-state-default">' + X.getDate() + "</span>" : '<a class="ui-state-default' + (X.getTime() == e.getTime() ? " ui-state-highlight" : "") + (X.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + X.getDate() + "</a>") + "</td>", X.setDate(X.getDate() + 1), X = this._daylightSavingAdjust(X)
                            }
                            R += Z + "</tr>"
                        }++p > 11 && (p = 0, f++), R += "</tbody></table>" + (h ? "</div>" + (o[0] > 0 && N == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), L += R
                    }
                    M += L
                }
            ...
            _generateMonthYearHeader: function(t, e, i, s, n, r, o, a) {
                ...
                if (c || (u += d + (!r && l && h ? "" : "&#xa0;")), !t.yearshtml) {
                    if (t.yearshtml = "", r || !h) u += '<span class="ui-datepicker-year">' + i + "</span>";
                    else {
                ...
                return u += this._get(t, "yearSuffix"), c && (u += (!r && l && h ? "" : "&#xa0;") + d), u += "</div>"
            },
        ...
        t.widget("ui.dialog", {
            ...
            _create: function() {
                ...
                var e = this,
                    ...
                    o = (e.uiDialog = t("<div></div>")).appendTo(document.body).hide().addClass(i + s.dialogClass).css({
                        zIndex: s.zIndex
                    ...
                    a = (e.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(o), (e.uiDialogTitlebar = t("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(o)),
                ...
                (e.uiDialogTitlebarCloseText = t("<span></span>")).addClass("ui-icon ui-icon-closethick").text(s.closeText).appendTo(l), t("<span></span>").addClass("ui-dialog-title").attr("id", r).html(n).prependTo(a), t.isFunction(s.beforeclose) && !t.isFunction(s.beforeClose) && (s.beforeClose = s.beforeclose), a.find("*").add(a).disableSelection(), s.draggable && t.fn.draggable && e._makeDraggable(), s.resizable && t.fn.resizable && e._makeResizable(), e._createButtons(s.buttons), e._isOpen = !1, t.fn.bgiframe && o.bgiframe()
            },
            _init: function() {
            ...
            moveToTop: function(e, i) {
                var s, n = this,
                    r = n.options;
                return (!r.modal || e) && (r.stack || r.modal) ? (r.zIndex > t.ui.dialog.maxZ && (t.ui.dialog.maxZ = r.zIndex), n.overlay && (t.ui.dialog.maxZ += 1, n.overlay.$el.css("z-index", t.ui.dialog.overlay.maxZ = t.ui.dialog.maxZ)), s = {
            ...
            _createButtons: function(e) {
                ...
                i.uiDialog.find(".ui-dialog-buttonpane").remove(), "object" == typeof e && null !== e && t.each(e, function() {
                    ...
                    t.each(s, function(t, e) {
                        "click" !== t && (t in r ? n[t](e) : n.attr(t, e))
            ...
            _makeDraggable: function() {
                ...
                s.uiDialog.draggable({
                    ...
                    start: function(r, o) {
                        i = "auto" === n.height ? "auto" : t(this).height(), t(this).height(t(this).height()).addClass("ui-dialog-dragging"), s._trigger("dragStart", r, e(o))
                    },
                    drag: function(t, i) {
                        s._trigger("drag", t, e(i))
                    },
                    stop: function(o, a) {
                        n.position = [a.position.left - r.scrollLeft(), a.position.top - r.scrollTop()], t(this).removeClass("ui-dialog-dragging").height(i), s._trigger("dragStop", o, e(a)), t.ui.dialog.overlay.resize()
                    }
                })
            },
            _makeResizable: function(e) {
                ...
                var s = this,
                    ...
                    o = "string" == typeof e ? e : "n,e,s,w,se,sw,ne,nw";
                s.uiDialog.resizable({
                    ...
                    stop: function(e, r) {
                        t(this).removeClass("ui-dialog-resizing"), n.height = t(this).height(), n.width = t(this).width(), s._trigger("resizeStop", e, i(r)), t.ui.dialog.overlay.resize()
                    }
            ...
            _setOptions: function(e) {
                ...
                t.each(e, function(t, e) {
                    i._setOption(t, e), t in s && (o = !0), t in n && (r[t] = e)
            ...
            _setOption: function(e, s) {
                ...
                switch (e) {
                    ...
                    case "closeText":
                        ...
                        break;
                    case "dialogClass":
                        r.removeClass(n.options.dialogClass).addClass(i + s);
                        break;
                    case "disabled":
                    ...
                    case "draggable":
                        ...
                        o && !s && r.draggable("destroy"), !o && s && n._makeDraggable();
                        break;
                    case "position":
                        n._position(s);
                        break;
                    case "resizable":
                        var a = r.is(":data(resizable)");
                        a && !s && r.resizable("destroy"), a && "string" == typeof s && r.resizable("option", "handles", s), a || !1 === s || n._makeResizable(s);
                        break;
                    case "title":
            ...
            _size: function() {
                ...
                if (this.element.show().css({
                    ...
                    if (t.support.minHeight) this.element.css({
                        ...
                        n || this.uiDialog.hide(), this.element.height(Math.max(r, i))
                    }
        ...
        t.fn.position = function(e) {
                ...
                return 9 === u.nodeType ? (a = c.width(), l = c.height(), h = {
                    ...
                    var i, s = t(this),
                        ...
                        g = o + u + (parseInt(t.curCSS(this, "marginRight", !0)) || 0),
                        m = c + f + (parseInt(t.curCSS(this, "marginBottom", !0)) || 0),
                        v = t.extend({}, h);
                    "right" === e.my[0] ? v.left -= o : e.my[0] === n && (v.left -= o / 2), "bottom" === e.my[1] ? v.top -= c : e.my[1] === n && (v.top -= c / 2), r.fractions || (v.left = Math.round(v.left), v.top = Math.round(v.top)), i = {
                        left: v.left - u,
                        top: v.top - f
                ...
                flip: {
                    left: function(e, i) {
                        if (i.at[0] !== n) {
                            var s = t(window),
                                r = i.collisionPosition.left + i.collisionWidth - s.width() - s.scrollLeft(),
                                o = "left" === i.my[0] ? -i.elemWidth : "right" === i.my[0] ? i.elemWidth : 0,
                                a = "left" === i.at[0] ? i.targetWidth : -i.targetWidth,
                                l = -2 * i.offset[0];
                            e.left += i.collisionPosition.left < 0 ? o + a + l : r > 0 ? o + a + l : 0
                        }
                    },
                    top: function(e, i) {
                        if (i.at[1] !== n) {
                            var s = t(window),
                                r = i.collisionPosition.top + i.collisionHeight - s.height() - s.scrollTop(),
                                o = "top" === i.my[1] ? -i.elemHeight : "bottom" === i.my[1] ? i.elemHeight : 0,
                                a = "top" === i.at[1] ? i.targetHeight : -i.targetHeight,
                                l = -2 * i.offset[1];
                            e.top += i.collisionPosition.top < 0 ? o + a + l : r > 0 ? o + a + l : 0
                        }
                    }
                }
            ...
            function() {
                ...
                e.appendChild(l), (i = a || document.documentElement).insertBefore(e, i.firstChild), l.style.cssText = "position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;", n = t(l).offset(function(t, e) {
                    return e
                }).offset(), e.innerHTML = "", i.removeChild(e), o = n.top + n.left + (a ? 2e3 : 0), r.fractions = o > 21 && o < 22
            }()
    }(jQuery),
    function(t, e) {
    ...
    function(t, e) {
        ...
        t.widget("ui.slider", t.ui.mouse, {
            ...
            _create: function() {
                ...
                for (var l = n.length; l < o; l += 1) a.push(r);
                this.handles = n.add(t(a.join("")).appendTo(e.element)), this.handle = this.handles.eq(0), this.handles.add(this.range).filter("a").click(function(t) {
                    ...
                    var n, r, o, a, l = t(this).data("index.ui-slider-handle");
                    if (!e.options.disabled) {
                        ...
                        switch (a = e.options.step, r = o = e.options.values && e.options.values.length ? e.values(l) : e.value(), s.keyCode) {
                            case t.ui.keyCode.HOME:
                                o = e._valueMin();
                                break;
                            case t.ui.keyCode.END:
                                ...
                                break;
                            case t.ui.keyCode.PAGE_UP:
                                o = e._trimAlignValue(r + (e._valueMax() - e._valueMin()) / i);
                                break;
                            case t.ui.keyCode.PAGE_DOWN:
                                o = e._trimAlignValue(r - (e._valueMax() - e._valueMin()) / i);
                                break;
                            case t.ui.keyCode.UP:
                            case t.ui.keyCode.RIGHT:
                                if (r === e._valueMax()) return;
                                o = e._trimAlignValue(r + a);
                                break;
                            case t.ui.keyCode.DOWN:
                            case t.ui.keyCode.LEFT:
                                if (r === e._valueMin()) return;
                                o = e._trimAlignValue(r - a)
                        }
                        e._slide(s, l, o)
                    }
            ...
            _mouseCapture: function(e) {
                var i, s, n, r, o, a, l, h, c, u = this.options;
                return !u.disabled && (this.elementSize = {
                    ...
                    x: e.pageX,
                    y: e.pageY
                }, s = this._normValueFromMouse(i), n = this._valueMax() - this._valueMin() + 1, o = this, this.handles.each(function(e) {
                    var i = Math.abs(s - o.values(e));
                    n > i && (n = i, r = t(this), a = e)
                }), !0 === u.range && this.values(1) === u.min && (a += 1, r = t(this.handles[a])), !1 !== (l = this._start(e, a)) && (this._mouseSliding = !0, o._handleIndex = a, r.addClass("ui-state-active").focus(), h = r.offset(), c = !t(e.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = c ? {
                    left: 0,
                    top: 0
                } : {
                    left: e.pageX - h.left - r.width() / 2,
                    top: e.pageY - h.top - r.height() / 2 - (parseInt(r.css("borderTopWidth"), 10) || 0) - (parseInt(r.css("borderBottomWidth"), 10) || 0) + (parseInt(r.css("marginTop"), 10) || 0)
            ...
            _slide: function(t, e, i) {
                var s, n, r;
                this.options.values && this.options.values.length ? (s = this.values(e ? 0 : 1), 2 === this.options.values.length && !0 === this.options.range && (0 === e && i > s || 1 === e && i < s) && (i = s), i !== this.values(e) && ((n = this.values())[e] = i, r = this._trigger("slide", t, {
                    handle: this.handles[e],
                    value: i,
                    values: n
                }), s = this.values(e ? 0 : 1), !1 !== r && this.values(e, i, !0))) : i !== this.value() && !1 !== (r = this._trigger("slide", t, {
                    handle: this.handles[e],
                    value: i
                })) && this.value(i)
            },
            ...
            values: function(e, i) {
                ...
                for (s = this.options.values, n = arguments[0], r = 0; r < s.length; r += 1) s[r] = this._trimAlignValue(n[r]), this._change(null, r);
                this._refreshValue()
            },
            _setOption: function(e, i) {
                var s, n = 0;
            ...
            _refreshValue: function() {
                var e, i, s, n, r, o = this.options.range,
                    a = this.options,
                    l = this,
                ...
                }) : (s = this.value(), n = this._valueMin(), e = (r = this._valueMax()) !== n ? (s - n) / (r - n) * 100 : 0, c["horizontal" === l.orientation ? "left" : "bottom"] = e + "%", this.handle.stop(1, 1)[h ? "animate" : "css"](c, a.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({
                    width: e + "%"
    ...
    function(t, e) {
        ...
        t.widget("ui.tabs", {
            ...
            _tabify: function(i) {
                ...
                this.list = this.element.find("ol,ul").eq(0), this.lis = t(" > li:has(a[href])", this.list), this.anchors = this.lis.map(function() {
                    ...
                    var s, n = t(i).attr("href"),
                        r = n.split("#")[0];
                    if (r && (r === location.toString().split("#")[0] || (s = t("base")[0]) && r === s.href) && (n = i.hash, i.href = n), l.test(n)) o.panels = o.panels.add(o.element.find(o._sanitizeSelector(n)));
                    else if (n && "#" !== n) {
                        t.data(i, "href.tabs", n), t.data(i, "load.tabs", n.replace(/#.*$/, ""));
                        var h = o._tabId(i);
                        i.href = "#" + h;
                        var c = o.element.find("#" + h);
                        c.length || (c = t(a.panelTemplate).attr("id", h).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(o.panels[e - 1] || o.list)).data("destroy.tabs", !0), o.panels = o.panels.add(c)
                ...
                }), "number" != typeof a.selected && a.cookie && (a.selected = parseInt(o._cookie(), 10)), "number" != typeof a.selected && this.lis.filter(".ui-tabs-selected").length && (a.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))), a.selected = a.selected || (this.lis.length ? 0 : -1)) : null === a.selected && (a.selected = -1), a.selected = a.selected >= 0 && this.anchors[a.selected] || a.selected < 0 ? a.selected : 0, a.disabled = t.unique(a.disabled.concat(t.map(this.lis.filter(".ui-state-disabled"), function(t, e) {
                    return o.lis.index(t)
                }))).sort(), -1 != t.inArray(a.selected, a.disabled) && a.disabled.splice(t.inArray(a.selected, a.disabled), 1), this.panels.addClass("ui-tabs-hide"), this.lis.removeClass("ui-tabs-selected ui-state-active"), a.selected >= 0 && this.anchors.length && (o.element.find(o._sanitizeSelector(o.anchors[a.selected].hash)).removeClass("ui-tabs-hide"), this.lis.eq(a.selected).addClass("ui-tabs-selected ui-state-active"), o.element.queue("tabs", function() {
                    o._trigger("show", null, o._ui(o.anchors[a.selected], o.element.find(o._sanitizeSelector(o.anchors[a.selected].hash))[0]))
                ...
                a.fx && (t.isArray(a.fx) ? (n = a.fx[0], r = a.fx[1]) : n = r = a.fx);
                var p = r ? function(e, i) {
                        t(e).closest("li").addClass("ui-tabs-selected ui-state-active"), i.hide().removeClass("ui-tabs-hide").animate(r, r.duration || "normal", function() {
                            s(i, r), o._trigger("show", null, o._ui(e, i[0]))
                        })
                    } : function(e, i) {
                    ...
                    f = n ? function(t, e) {
                        e.animate(n, n.duration || "normal", function() {
                            o.lis.removeClass("ui-tabs-selected ui-state-active"), e.addClass("ui-tabs-hide"), s(e, n), o.element.dequeue("tabs")
                        })
                    } : function(t, e, i) {
                ...
                this.anchors.bind(a.event + ".tabs", function() {
                    ...
                    if (i.hasClass("ui-tabs-selected") && !a.collapsible || i.hasClass("ui-state-disabled") || i.hasClass("ui-state-processing") || o.panels.filter(":animated").length || !1 === o._trigger("select", null, o._ui(this, n[0]))) return this.blur(), !1;
                    if (a.selected = o.anchors.index(this), o.abort(), a.collapsible) {
                        if (i.hasClass("ui-tabs-selected")) return a.selected = -1, a.cookie && o._cookie(a.selected, a.cookie), o.element.queue("tabs", function() {
                            f(e, s)
                        }).dequeue("tabs"), this.blur(), !1;
                        if (!s.length) return a.cookie && o._cookie(a.selected, a.cookie), o.element.queue("tabs", function() {
                            p(e, n)
                        }), o.load(o.anchors.index(this)), this.blur(), !1
                    }
                    if (a.cookie && o._cookie(a.selected, a.cookie), n.length) s.length && o.element.queue("tabs", function() {
                        f(e, s)
            ...
            add: function(i, s, n) {
                ...
                var r = this,
                    o = this.options,
                    a = t(o.tabTemplate.replace(/#\{href\}/g, i).replace(/#\{label\}/g, s)),
                    l = i.indexOf("#") ? this._tabId(t("a", a)[0]) : i.replace("#", "");
                a.addClass("ui-state-default ui-corner-top").data("destroy.tabs", !0);
                var h = r.element.find("#" + l);
                return h.length || (h = t(o.panelTemplate).attr("id", l).data("destroy.tabs", !0)), h.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"), n >= this.lis.length ? (a.appendTo(this.list), h.appendTo(this.list[0].parentNode)) : (a.insertBefore(this.lis[n]), h.insertBefore(this.panels[n])), o.disabled = t.map(o.disabled, function(t, e) {
                    return t >= n ? ++t : t
                }), this._tabify(), 1 == this.anchors.length && (o.selected = 0, a.addClass("ui-tabs-selected ui-state-active"), h.removeClass("ui-tabs-hide"), this.element.queue("tabs", function() {
                    r._trigger("show", null, r._ui(r.anchors[0], r.panels[0]))
            ...
            load: function(e) {
                ...
                var i = this,
                    ...
                    r = t.data(n, "load.tabs");
                if (this.abort(), !r || 0 !== this.element.queue("tabs").length && t.data(n, "cache.tabs")) {
                ...
                return this.xhr = t.ajax(t.extend({}, s.ajaxOptions, {
                    ...
                    success: function(r, o) {
                        i.element.find(i._sanitizeSelector(n.hash)).html(r), i._cleanup(), s.cache && t.data(n, "cache.tabs", !0), i._trigger("load", null, i._ui(i.anchors[e], i.panels[e]));
                        try {
                            s.ajaxOptions.success(r, o)
                        } catch (a) {}
                    },
                    error: function(t, r, o) {
                        i._cleanup(), i._trigger("load", null, i._ui(i.anchors[e], i.panels[e]));
                        try {
                            s.ajaxOptions.error(t, r, e, n)
                        } catch (a) {}
                    }
            ...
            rotate: function(t, e) {
                var i = this,
                    ...
                    r = i._unrotate || (i._unrotate = e ? function(t) {
                        n()
                    } : function(t) {
                        t.clientX && i.rotate(null)
                    });
                return t ? (this.element.bind("tabsshow", n), this.anchors.bind(s.event + ".tabs", r), n()) : (clearTimeout(i.rotation), this.element.unbind("tabsshow", n), this.anchors.unbind(s.event + ".tabs", r), delete this._rotate, delete this._unrotate), this
            }
        })
    }(jQuery),
    function(t, e) {
        ...
        t.each("branch form header step wrapper".split(" "), function() {
            ...
            _create: function() {
                ...
                p[0].elements ? e = p : (e = p.find(l)).length || (e = p.closest(l)), (r = p.find(d.header)).length || (r = e.find(d.header)), h.elements = {
                    form: e.addClass(n.form),
                    submit: e.find(d.submit),
                    forward: e.find(d.forward),
                    backward: e.find(d.backward),
                    header: r.addClass(n.header),
                ...
                }), h.select.apply(h, o(d.initialStep))
            },
            _fastForward: function(i, s, n) {
                var r = 0,
                    o = this,
                    a = o._currentState.stepIndex,
                    l = [a];
                t.isFunction(s) && (n = s, s = e),
                    function e() {
                        o._transition(a, function(h, c) {
                            if (-1 === (a = o.stepIndex(h, c))) throw Error('[_fastForward]: Invalid step "' + h + '"');
                            if (t.inArray(a, l) >= 0) throw Error('[_fastForward]: Recursion detected on step "' + h + '"');
                            l.push(a), a === o._lastStepIndex || (s ? ++r : a) === i ? n.call(o, a, l) : e()
                        })
                    }()
            },
            _find: function(e, i, s) {
                ...
                if (null !== e && u.length)
                    for (r = 0, a = (e = o(e)).length; r < a; r++) n = null, (h = typeof(l = e[r])) === d ? n = u.get(l) : h === f ? n = document.getElementById(l.replace("#", "")) : h === p && (l instanceof jQuery && l.length && (l = l[0]), l.nodeType && u.each(g)), n && c.push(n);
                return !1 === s ? c : t(c)
            },
            _move: function(i, s, n, r, o) {
                var a = this,
                    l = a._currentState;

                function h(i, s) {
                    o.call(a, i, t.isArray(r) ? r : !1 !== r ? s : e)
                }
                typeof s === g && (o = r, r = n, n = s, s = e), !0 === n ? i > 0 ? a._fastForward(i, n, h) : o.call(a, l.stepsActivated[Math.max(0, i + (l.stepsActivated.length - 1))]) : -1 !== (i = a.stepIndex(i, s)) && (i > l.stepIndex ? a._fastForward(i, h) : h.call(a, i))
            },
            _state: function(e, i) {
                if (!this.isValidStepIndex(e)) return null;
                this.options;
                var n = t.extend(!0, {}, this._currentState);
                i = o(i || e), n.step = this.elements.steps.eq(e), n.branch = n.step.parent(), n.branchStepCount = n.branch.children(s.step).length, n.isMovingForward = e > n.stepIndex, n.stepIndexInBranch = n.branch.children(s.step).index(n.step);
                for (var r, a, l, h = 0, c = i.length; h < c; h++) e = i[h], r = this._branchLabels[e], !n.stepIndex || n.stepIndex < e ? 0 > t.inArray(e, n.stepsActivated) && (n.stepsActivated.push(e), 0 > t.inArray(r, n.branchesActivated) && n.branchesActivated.push(r)) : n.stepIndex > e && (a = t.inArray(r, n.branchesActivated) + 1, l = t.inArray(e, n.stepsActivated) + 1, a > 0 && n.branchesActivated.splice(a, n.branchesActivated.length - 1), l > 0 && n.stepsActivated.splice(l, n.stepsActivated.length - 1)), n.stepIndex = e, n.branchLabel = r;
            ...
            destroy: function() {
                var e = this.elements;
                this._trigger(w, null, this.state()) && (this.element.removeClass(c), e.form.removeClass(n.form), e.header.removeClass(n.header), e.steps.show().removeClass(n.step), e.stepsWrapper.removeClass(n.wrapper), e.branches.removeClass(n.branch), t.Widget.prototype.destroy.call(this), this._trigger(v))
            },
            form: function() {
            ...
            select: function(i, s, n, r, o) {
                i instanceof t.Event || (o = r, r = n, n = s, s = i, i = e), s !== e && (t.isArray(s) ? (o = r, r = n, n = s[1], s = s[0]) : typeof n === g ? (o = r, r = n, n = e) : t.isArray(n) && (o = n, n = e), this._move(s, n, r, o, function(t, e) {
            ...
            step: function(i, s) {
                var r;
                return arguments.length ? (t.isArray(i) && (s = i[1], i = i[0]), typeof i === d ? r = this._find(i, s !== e ? this.steps(s) : this.elements.steps) : (r = this._find(i, this.elements.steps.add(this.elements.branches))) && r.hasClass(n.branch) && (r = this._find(s || 0, this.steps(r))), r) : this._currentState.step
            },
            stepIndex: function(i, n, r) {
                var o;
                return arguments.length ? (t.isArray(i) ? (r = n, n = i[1], i = i[0]) : typeof n === g && (r = n, n = e), (o = this.step(i, n)) ? (r ? o.siblings(s.step).andSelf() : this.elements.steps).index(o) : -1) : this._currentState.stepIndex
            },
            steps: function(t) {
    ...
    function(t) {
        t.extend(t.fn, {
            ...
            rules: function(e, i) {
                ...
                if (e) {
                    var n = t.data(s.form, "validator").settings,
                        r = n.rules,
                        o = t.validator.staticRules(s);
                    switch (e) {
                        case "add":
                            t.extend(o, t.validator.normalizeRule(i)), delete o.messages, r[s.name] = o, i.messages && (n.messages[s.name] = t.extend(n.messages[s.name], i.messages));
                            break;
                        case "remove":
                            if (!i) return delete r[s.name], o;
                            var a = {};
            ...
            prototype: {
                ...
                check: function(e) {
                    ...
                    for (var o in s) {
                        ...
                        try {
                            if (i = t.validator.methods[o].call(this, r, e, a.parameters), "dependency-mismatch" === i) {
                                n = !0;
                                continue
                            }
                            if (n = !1, "pending" === i) {
            ...
            attributeRules: function(e) {
                ...
                for (var o in t.validator.methods) "required" === o ? ("" === (i = n.get(0).getAttribute(o)) && (i = !0), i = !!i) : i = n.attr(o), /min|max/.test(o) && (null === r || /number|range|text/.test(r)) && (i = Number(i)), i ? s[o] = i : r === o && "range" !== r && (s[o] = !0);
            ...
            methods: {
                ...
                creditcard: function(t, e) {
                    ...
                    var i = 0,
                        ...
                        n = !1;
                    t = t.replace(/\D/g, "");
                    for (var r = t.length - 1; r >= 0; r--) s = parseInt(t.charAt(r), 10), n && (s *= 2) > 9 && (s -= 9), i += s, n = !n;
                    return i % 10 == 0
                },
                    ...
                    return o[i.name] = e, t.ajax(t.extend(!0, {
                        ...
                        success: function(s) {
                            ...
                            if (o) {
                                ...
                                r.prepareElement(i), r.formSubmitted = a, r.successList.push(i), delete r.invalid[i.name], r.showErrors()
                            } else {
                                var l = {},
                                    h = s || r.defaultMessage(i, "remote");
                                l[i.name] = n.message = t.isFunction(h) ? h(e) : h, r.invalid[i.name] = !0, r.showErrors(l)
                            }
                            n.valid = o, r.stopRequest(i, o)
                        }
                    }, s)), "pending"
                }
            }
    ...
    function(t) {
        ...
        if (t.ajaxPrefilter) t.ajaxPrefilter(function(t, i, s) {
            ...
            t.ajax = function(s) {
                ...
                return "abort" === n ? (e[r] && e[r].abort(), e[r] = i.apply(this, arguments), e[r]) : i.apply(this, arguments)
            }
        }
    }(jQuery),
    function(t) {
    ...
    function(t, e, i) {
        "use strict";
        var s = function(t, i) {
            this.el_ = this.isString_(t) ? e.querySelectorAll(t) : [t], this.config_ = [], this.options_ = i, this.selectors_ = [], this.init_(), this.destroy = function() {
                this.loop_(function(t) {
        ...
        s.prototype = {
            ...
            init_: function() {
                var t = this;
                t.initEvents_(), t.loop_(function(e, i) {
            ...
            initEvents_: function() {
                var t = this;
                t.events = {
                    blur: t.onBlur_.bind(t),
                    change: t.onInput_.bind(t),
                    focus: t.onFocus_.bind(t),
                    input: t.onInput_.bind(t),
                    reset: t.onReset_.bind(t)
                }
            },
            ...
            build_: function(t) {
                var e = this,
                    i = e.getLabel_(t);
                i && (t.classList.add(e.prefixed_(t.tagName.toLowerCase())), e.setLabel_(i, t), e.setPlaceholder_(i, t), e.wrapLabel_(i, t), e.handleEvents_(t, "add"), "function" == typeof e.config_[e.current_].customEvent && e.config_[e.current_].customEvent.call(e, t))
            },
                ...
                for (var i = this, s = 0; s < i.el_.length; ++s) {
                    if (void 0 === i.selectors_[s]) {
                        var n = i.extend_({}, i.defaults_, i.options_, i.el_[s].getAttribute("data-options")),
                            r = ":not(" + n.exclude.split(/[\s,]+/).join("):not(") + ")";
                        i.selectors_[s] = n.transform.replace(/,/g, r + ",") + r, i.config_[s] = n
                    }
                    var o = i.el_[s].querySelectorAll(i.selectors_[s]);
                    i.current_ = s, "function" == typeof t && t.call(i, i.el_[s], s);
                    for (var a = 0; a < o.length; ++a) "function" == typeof e && e.call(i, o[a], s)
                }
            },
            onBlur_: function(t) {
            ...
            reset_: function(t) {
                var i = this,
                    s = t.parentNode;
                if (i.hasParent_(t)) {
                    for (var n = e.createDocumentFragment(); s.firstElementChild;) {
                        var r = s.firstElementChild;
                        i.removeClasses_(r), n.appendChild(r)
                    }
                    s.parentNode.replaceChild(n, s), i.resetPlaceholder_(t), i.handleEvents_(t, "remove")
                }
            },
            resetFields_: function() {
                for (var t = this, e = t.el_[t.current_].querySelectorAll(t.selectors_[t.current_]), i = 0; i < e.length; ++i) e[i].parentNode.classList[t.addRemove_("SELECT" === e[i].tagName && "" !== e[i].value)](t.prefixed_("is-active"))
            },
            ...
            setLabel_: function(t, e) {
                var i = this;
                t.classList.add(i.prefixed_("label")), t.textContent = i.getLabelText_(t, e), "function" == typeof i.config_[i.current_].customLabel && (t.textContent = i.config_[i.current_].customLabel.call(i, t, e))
            },
            setPlaceholder_: function(t, e) {
                var i = this,
                    s = e.getAttribute("placeholder");
                "label" !== i.config_[i.current_].prioritize && s || (s && e.setAttribute("data-placeholder", s), s = i.getLabelText_(t, e)), "function" == typeof i.config_[i.current_].customPlaceholder && (s = i.config_[i.current_].customPlaceholder.call(i, s, e, t)), "SELECT" === e.tagName ? i.setSelectPlaceholder_(e, s) : e.setAttribute("placeholder", s)
            },
            setSelectPlaceholder_: function(t, e) {
                var i = t.firstElementChild;
                i.hasAttribute("value") && i.value ? (t.insertBefore(new Option(e, ""), i), !1 === t.options[t.selectedIndex].defaultSelected && (t.selectedIndex = 0)) : i.setAttribute("value", ""), "" === i.textContent && (i.textContent = e)
            },
            wrapLabel_: function(t, e) {
                var i = this,
                    s = i.createEl_("div", {
                        class: i.prefixed_("wrap") + " " + i.prefixed_("wrap-" + e.tagName.toLowerCase())
                    });
                void 0 !== e.value && e.value.length && s.classList.add(i.prefixed_("is-active")), (null !== e.getAttribute("required") || e.classList.contains(i.config_[i.current_].requiredClass)) && s.classList.add(i.prefixed_("is-required")), e.parentNode.insertBefore(s, e), s.appendChild(t), s.appendChild(e)
            }
        }, "function" == typeof define && define.amd ? define([], function() {
            return s
        }) : "object" == typeof module && module.exports ? module.exports = s : t.FloatLabels = s
    }(window, document);