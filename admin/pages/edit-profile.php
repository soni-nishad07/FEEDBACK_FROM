  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/table.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="card card-body mx-3 mx-md-4 mt-n6">
        ...
        <div class="row">
          <div class="row">
            ...
            <div class="col-12 col-xl-12 d-flex flex-column">
            <form method="post" action="editprofilecode.php">
                  <div class="card-body">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-auto"><span class="avatar avatar-xl" style="background-image: url(<?php echo $row["profileimg"] ?>)"></span>
                      </div>
                      <div class="col-auto">

                      <input type="file" id="actual-btn" hidden name="profile"/>
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row["mobilenumber"] ?>" name="phone">
                      </div>
                    ...
                    <div>
                      <div class="row g-2">
                        <div class="col-auto">
                          <input type="text" class="form-control w-auto" value="<?php echo $row["email"] ?>" name="email">
                        </div>
                    ...
                    <div class="row g-2">
                        <div class="col-auto">
                          <input type="password" class="form-control w-auto" value="<?php echo $row["password"] ?>" name="password">
                        </div>
                     
                      </div>
                    <h5 class="card-title mt-4">Public profile</h5>
                  ...
                  <div class="card-footer bg-transparent mt-auto">
                    <div class="btn-list justify-content-end">
                      ...
                      <!-- <a href="#" class=" btn btn-primary mx-3" type="submit" name="submit">
                        Submit
                      </a> -->
                      <input type="hidden" value="<?php echo $row["id"] ?>" name="id"/>
                      <button  class=" btn btn-primary mx-3" type="submit" name="submit"> Chnage Profile </button>
