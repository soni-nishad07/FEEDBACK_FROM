...
$query1="select * from tbl_feedback1 where rate<=2";
$res1=mysqli_query($con,$query1);
$row1=mysqli_num_rows($res1);
$query2="select * from tbl_feedback1 where  rate<=4 and rate>2";
$res2=mysqli_query($con,$query2);
$row2=mysqli_num_rows($res2);
$query3="select * from tbl_feedback1 where rate=5";
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item dropdown pe-2 d-flex align-items-center">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="edit-profile.php">
                                        <div class="d-flex">
                                            <div class="my-auto">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Total Negative Feedback</p>
                                <h4 class="mb-0"><?php echo $row1; ?></h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">POsitive Feedback</p>
                                <h4 class="mb-0"><?php  echo $row2;
 ?></h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Top feedback</p>
                                <h4 class="mb-0"> <?php  echo $row3;
 ?></h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
